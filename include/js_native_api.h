...
NAPI_EXTERN napi_status NAPI_CDECL napi_get_global(napi_env env,
                                                   napi_value *result);
NAPI_EXTERN napi_status NAPI_CDECL napi_get_boolean(napi_env env, bool value,
                                                    napi_value *result);
...
NAPI_EXTERN napi_status NAPI_CDECL napi_typeof(napi_env env, napi_value value,
...
NAPI_EXTERN napi_status NAPI_CDECL napi_is_array(napi_env env, napi_value value,
                                                 bool *result);
...
NAPI_EXTERN napi_status NAPI_CDECL
napi_call_function(napi_env env, napi_value recv, napi_value func, size_t argc,
...
NAPI_EXTERN napi_status NAPI_CDECL napi_wrap(napi_env env, napi_value js_object,
                                             void *native_object,
...
NAPI_EXTERN napi_status NAPI_CDECL node_api_throw_syntax_error(napi_env env,
                                                               ...
                                                               const char *msg);
#endif // NAPI_VERSION >= 9
NAPI_EXTERN napi_status NAPI_CDECL napi_is_error(napi_env env, napi_value value,
                                                 bool *result);
...
// Dates
NAPI_EXTERN napi_status NAPI_CDECL napi_create_date(napi_env env, double time,
                                                    napi_value *result);

NAPI_EXTERN napi_status NAPI_CDECL napi_is_date(napi_env env, napi_value value,
                                                bool *is_date);
...
NAPI_EXTERN napi_status NAPI_CDECL napi_add_finalizer(
    napi_env env, napi_value js_object, void *finalize_data,
...
NAPI_EXTERN napi_status NAPI_CDECL
napi_check_object_type_tag(napi_env env, napi_value value,
