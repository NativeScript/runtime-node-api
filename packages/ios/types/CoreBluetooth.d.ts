...
declare const CBCentralManagerFeature: {
...
declare interface CBCentralManagerDelegate extends NSObjectProtocol {
  ...
  centralManagerConnectionEventDidOccurForPeripheral?(central: CBCentralManager, event: interop.Enum<typeof CBConnectionEvent>, peripheral: CBPeripheral): void;
...
declare class CBCentralManager extends CBManager {
  ...
  static supportsFeatures(features: interop.Enum<typeof CBCentralManagerFeature>): boolean;
