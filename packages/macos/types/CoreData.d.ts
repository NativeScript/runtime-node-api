...
declare const NSObjectURIKey: string;

declare const NSModelPathKey: string;

declare const NSStorePathKey: string;

declare const NSStoreUUIDInPathKey: string;

declare const NSExternalRecordsDirectoryOption: string;

declare const NSExternalRecordsFileFormatOption: string;

declare const NSBinaryExternalRecordType: string;

declare const NSXMLExternalRecordType: string;
...
declare const NSValidateXMLStoreOption: string;
...
declare class NSPersistentStoreCoordinator extends NSObject implements NSLocking {
  ...
  importStoreWithIdentifierFromExternalRecordsDirectoryToURLOptionsWithTypeError(storeIdentifier: string | null, externalRecordsURL: NSURL, destinationURL: NSURL, options: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null, storeType: string, error: interop.PointerConvertible): NSPersistentStore;
