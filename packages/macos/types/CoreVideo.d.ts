...
declare class __CVOpenGLTextureCache {
  constructor(init?: __CVOpenGLTextureCache);
}
...
declare class __CVDisplayLink {
  constructor(init?: __CVDisplayLink);
}
...
declare function CVDisplayLinkCreateWithCGDisplays(displayArray: interop.PointerConvertible, count: number, displayLinkOut: interop.PointerConvertible): number;

declare function CVDisplayLinkCreateWithOpenGLDisplayMask(mask: number, displayLinkOut: interop.PointerConvertible): number;

declare function CVDisplayLinkCreateWithCGDisplay(displayID: number, displayLinkOut: interop.PointerConvertible): number;
