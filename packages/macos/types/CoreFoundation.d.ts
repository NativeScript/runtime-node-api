...
declare const kCFDateFormatterPMSymbol: interop.Pointer;

declare const kCFAllocatorNull: interop.Pointer;
...
declare const kCFStringTransformStripDiacritics: interop.Pointer;
...
declare const kCFURLVolumeSupportsVolumeSizesKey: interop.Pointer;
...
declare const kCFURLVolumeSupportsSparseFilesKey: interop.Pointer;

declare const kCFLocaleAlternateQuotationBeginDelimiterKey: interop.Pointer;
...
declare const kCFUserNotificationAlertHeaderKey: interop.Pointer;
...
declare const kCFURLGenerationIdentifierKey: interop.Pointer;

declare const kCFNull: interop.Pointer;

declare const kCFSocketValueKey: interop.Pointer;

declare const kCFStreamPropertyDataWritten: interop.Pointer;
...
declare const kCFURLUbiquitousItemDownloadingStatusKey: interop.Pointer;
...
declare const kCFErrorUnderlyingErrorKey: interop.Pointer;
...
declare const kCFXMLTreeErrorLocation: interop.Pointer;
...
declare const kCFURLLocalizedLabelKey: interop.Pointer;
...
declare const kCFLocaleGroupingSeparator: interop.Pointer;
...
declare const kCFURLCustomIconKey: interop.Pointer;
...
declare const kCFNumberFormatterMaxSignificantDigits: interop.Pointer;
...
declare const kCFRepublicOfChinaCalendar: interop.Pointer;

declare const kCFStreamPropertySocketRemotePortNumber: interop.Pointer;

declare const kCFURLFileAllocatedSizeKey: interop.Pointer;
...
declare const kCFURLIsApplicationKey: interop.Pointer;

declare const kCFNumberFormatterCurrencySymbol: interop.Pointer;

declare const kCFNumberFormatterRoundingMode: interop.Pointer;

declare const kCFURLMayHaveExtendedAttributesKey: interop.Pointer;

declare const kCFUserNotificationOtherResponse: number;

declare const kCFURLIsExecutableKey: interop.Pointer;
...
declare const kCFURLVolumeSupportsPersistentIDsKey: interop.Pointer;
...
declare const kCFURLTotalFileSizeKey: interop.Pointer;

declare const kCFURLContentModificationDateKey: interop.Pointer;
...
declare const kCFPlugInUnloadFunctionKey: interop.Pointer;

declare const kCFAllocatorMalloc: interop.Pointer;

declare const kCFURLPathKey: interop.Pointer;

declare const kCFURLFileLastModificationTime: interop.Pointer;
...
declare const kCFURLVolumeTypeNameKey: interop.Pointer;

declare const kCFUserNotificationDefaultButtonTitleKey: interop.Pointer;

declare const kCFURLAddedToDirectoryDateKey: interop.Pointer;

declare const kCFTypeArrayCallBacks: CFArrayCallBacks;

declare const kCFUserNotificationLocalizationURLKey: interop.Pointer;
...
declare const kCFURLVolumeTotalCapacityKey: interop.Pointer;

declare const kCFURLCanonicalPathKey: interop.Pointer;

declare const kCFStringTokenizerUnitSentence: number;

declare const kCFURLVolumeSupportsExclusiveRenamingKey: interop.Pointer;

declare const kCFURLUbiquitousItemPercentUploadedKey: interop.Pointer;
...
declare const kCFURLIsExcludedFromBackupKey: interop.Pointer;
...
declare const kCFUserNotificationKeyboardTypesKey: interop.Pointer;

declare const kCFISO8601Calendar: interop.Pointer;

declare const kCFNumberFormatterNegativePrefix: interop.Pointer;

declare const kCFNumberFormatterCurrencyDecimalSeparator: interop.Pointer;

declare const kCFDateFormatterLongEraSymbols: interop.Pointer;
...
declare const kCFURLVolumeAvailableCapacityKey: interop.Pointer;

declare const kCFPreferencesAnyHost: interop.Pointer;

declare const kCFURLVolumeIsRemovableKey: interop.Pointer;

declare const kCFDateFormatterDefaultDate: interop.Pointer;

declare const kCFUserNotificationAlternateButtonTitleKey: interop.Pointer;

declare const kCFBundleExecutableKey: interop.Pointer;

declare const kCFLocaleCurrencyCode: interop.Pointer;

declare const kCFURLIsSymbolicLinkKey: interop.Pointer;

declare const kCFURLTagNamesKey: interop.Pointer;
...
declare const kCFStringTransformLatinThai: interop.Pointer;
...
declare const kCFDateFormatterStandaloneMonthSymbols: interop.Pointer;

declare const kCFNumberFormatterZeroSymbol: interop.Pointer;
...
declare const kCFURLVolumeSupportsFileProtectionKey: interop.Pointer;
...
declare const kCFSocketErrorKey: interop.Pointer;
...
declare const kCFURLQuarantinePropertiesKey: interop.Pointer;
...
declare const kCFIslamicCalendar: interop.Pointer;

declare const kCFNumberFormatterPositiveSuffix: interop.Pointer;

declare const kCFBundleVersionKey: interop.Pointer;

declare const kCFLocaleCollationIdentifier: interop.Pointer;
...
declare const kCFAllocatorDefault: interop.Pointer;
...
declare const kCFStringTransformHiraganaKatakana: interop.Pointer;
...
declare const kCFIslamicCivilCalendar: interop.Pointer;

declare const kCFStreamPropertyShouldCloseNativeSocket: interop.Pointer;

declare const kCFBundleNameKey: interop.Pointer;

declare const kCFAllocatorSystemDefault: interop.Pointer;

declare const kCFDateFormatterCalendarName: interop.Pointer;
...
declare const kCFURLFileResourceTypeSymbolicLink: interop.Pointer;

declare const kCFErrorDescriptionKey: interop.Pointer;

declare const kCFMessagePortBecameInvalidError: number;

declare const kCFAbsoluteTimeIntervalSince1970: number;

declare const kCFLocaleExemplarCharacterSet: interop.Pointer;

declare const kCFXMLTreeErrorLineNumber: interop.Pointer;

declare const kCFURLVolumeSupportsExtendedSecurityKey: interop.Pointer;

declare const kCFXMLTreeErrorStatusCode: interop.Pointer;

declare const kCFNumberFormatterMinGroupingDigits: interop.Pointer;
...
declare const kCFSocketRetrieveCommand: interop.Pointer;

declare const kCFStringTransformLatinHangul: interop.Pointer;

declare const kCFURLVolumeIdentifierKey: interop.Pointer;

declare const kCFTypeSetCallBacks: CFSetCallBacks;

declare const kCFURLFileIdentifierKey: interop.Pointer;
...
declare const kCFUserNotificationTextFieldTitlesKey: interop.Pointer;

declare const kCFURLLabelNumberKey: interop.Pointer;

declare const kCFBooleanTrue: interop.Pointer;
...
declare const kCFNumberFormatterPlusSign: interop.Pointer;
...
declare const kCFDateFormatterDoesRelativeDateFormattingKey: interop.Pointer;
...
declare const kCFStringTransformStripCombiningMarks: interop.Pointer;

declare const kCFURLVolumeLocalizedNameKey: interop.Pointer;
...
declare const kCFNumberFormatterDecimalSeparator: interop.Pointer;

declare const kCFBundleIdentifierKey: interop.Pointer;

declare const kCFDateFormatterTimeZone: interop.Pointer;

declare const kCFSocketResultKey: interop.Pointer;
...
declare const kCFXMLTreeErrorDescription: interop.Pointer;
...
declare const kCFURLIsSystemImmutableKey: interop.Pointer;
...
declare const kCFUserNotificationAlertMessageKey: interop.Pointer;

declare const kCFURLUbiquitousItemDownloadingStatusDownloaded: interop.Pointer;
...
declare const kCFURLUbiquitousItemIsExcludedFromSyncKey: interop.Pointer;

declare const kCFURLUbiquitousItemUploadingErrorKey: interop.Pointer;

declare const kCFNumberFormatterMinIntegerDigits: interop.Pointer;

declare const kCFURLUbiquitousItemIsDownloadingKey: interop.Pointer;

declare const kCFURLIsUserImmutableKey: interop.Pointer;

declare const kCFURLUbiquitousItemHasUnresolvedConflictsKey: interop.Pointer;

declare const kCFURLKeysOfUnsetValuesKey: interop.Pointer;
...
declare const kCFURLFileLength: interop.Pointer;

declare const kCFURLVolumeIsJournalingKey: interop.Pointer;

declare const kCFDateFormatterEraSymbols: interop.Pointer;

declare const kCFDateFormatterVeryShortStandaloneMonthSymbols: interop.Pointer;

declare const kCFURLLabelColorKey: interop.Pointer;

declare const kCFURLFileResourceTypeCharacterSpecial: interop.Pointer;

declare const kCFURLFileResourceTypeNamedPipe: interop.Pointer;

declare const kCFURLDirectoryEntryCountKey: interop.Pointer;

declare const kCFStreamPropertySOCKSProxyPort: interop.Pointer;

declare const kCFURLDocumentIdentifierKey: interop.Pointer;

declare const kCFURLHTTPStatusLine: interop.Pointer;

declare const kCFURLIsWritableKey: interop.Pointer;

declare const kCFURLVolumeURLKey: interop.Pointer;

declare const kCFUserNotificationUseRadioButtonsFlag: number;

declare const kCFURLMayShareFileContentKey: interop.Pointer;
...
declare const kCFNumberFormatterUseSignificantDigits: interop.Pointer;

declare const kCFUserNotificationPopUpSelectionKey: interop.Pointer;

declare const kCFNumberFormatterMaxIntegerDigits: interop.Pointer;

declare const kCFURLVolumeSupportsHardLinksKey: interop.Pointer;

declare const kCFNotificationPostToAllSessions: number;

declare const kCFDateFormatterCalendar: interop.Pointer;
...
declare const kCFNumberFormatterExponentSymbol: interop.Pointer;
...
declare const kCFStringTransformLatinCyrillic: interop.Pointer;

declare const kCFURLVolumeSupportsAdvisoryFileLockingKey: interop.Pointer;

declare const kCFCopyStringDictionaryKeyCallBacks: CFDictionaryKeyCallBacks;

declare const kCFURLPreferredIOBlockSizeKey: interop.Pointer;
...
declare const CFXMLEntityTypeCode: {
  Parameter: 0,
  ParsedInternal: 1,
  ParsedExternal: 2,
  Unparsed: 3,
...
declare const CFURLEnumeratorResult: {
  Success: 1,
  End: 2,
  Error: 3,
...
declare const CFURLEnumeratorOptions: {
  DefaultBehavior: 0,
...
declare const CFStringTokenizerTokenType: {
  None: 0,
  Normal: 1,
  HasSubTokensMask: 2,
...
declare const CFGregorianUnitFlags: {
  UnitsYears: 1,
  UnitsMonths: 2,
  UnitsDays: 4,
  UnitsHours: 8,
...
declare const CFSocketCallBackType: {
  No: 0,
  Read: 1,
  Accept: 2,
  Data: 3,
...
declare const CFStringCompareFlags: {
  CaseInsensitive: 1,
  Backwards: 4,
  Anchored: 8,
  Nonliteral: 16,
...
declare const CFPropertyListFormat: {
  OpenStepFormat: 1,
  XMLFormat_v1_0: 100,
...
declare const CFRunLoopRunResult: {
  Finished: 1,
  Stopped: 2,
  TimedOut: 3,
  HandledSource: 4,
...
declare class CFXMLProcessingInstructionInfo {
  constructor(init?: CFXMLProcessingInstructionInfo);
  dataString: interop.Pointer;
}

declare class CFTreeContext {
  constructor(init?: CFTreeContext);
  version: number;
...
declare class __CFCharacterSet {
  constructor(init?: __CFCharacterSet);
}
...
declare class CGAffineTransform {
  constructor(init?: CGAffineTransform);
  a: number;
  b: number;
  c: number;
  d: number;
...
declare class CFSwappedFloat32 {
  constructor(init?: CFSwappedFloat32);
  v: number;
}

declare class CFXMLNotationInfo {
  constructor(init?: CFXMLNotationInfo);
...
declare class CGAffineTransformComponents {
  constructor(init?: CGAffineTransformComponents);
  scale: CGSize;
...
declare class __CFRunLoopTimer {
  constructor(init?: __CFRunLoopTimer);
}
...
declare class __CFStringTokenizer {
  constructor(init?: __CFStringTokenizer);
}

declare class CFRange {
  constructor(init?: CFRange);
  location: number;
  length: number;
}

declare class CFXMLAttributeDeclarationInfo {
  constructor(init?: CFXMLAttributeDeclarationInfo);
  attributeName: interop.Pointer;
  typeString: interop.Pointer;
  defaultString: interop.Pointer;
}

declare class __CFString {
  constructor(init?: __CFString);
}

declare class CFBinaryHeapCompareContext {
  constructor(init?: CFBinaryHeapCompareContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare class CFMessagePortContext {
  constructor(init?: CFMessagePortContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare class CFSetCallBacks {
  constructor(init?: CFSetCallBacks);
  version: number;
  retain: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void | null;
  copyDescription: (p1: interop.PointerConvertible) => interop.Pointer | null;
...
declare class __CFXMLParser {
  constructor(init?: __CFXMLParser);
}

declare class CFXMLElementInfo {
  constructor(init?: CFXMLElementInfo);
  attributes: interop.Pointer;
  attributeOrder: interop.Pointer;
  isEmpty: number;
  _reserved: unknown /* const array */;
}

declare class CFBagCallBacks {
  constructor(init?: CFBagCallBacks);
  version: number;
  retain: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void | null;
  copyDescription: (p1: interop.PointerConvertible) => interop.Pointer | null;
...
declare class __CFReadStream {
  constructor(init?: __CFReadStream);
}
...
declare class CFXMLEntityReferenceInfo {
  constructor(init?: CFXMLEntityReferenceInfo);
  entityType: interop.Enum<typeof CFXMLEntityTypeCode>;
}

declare class CFXMLElementTypeDeclarationInfo {
  constructor(init?: CFXMLElementTypeDeclarationInfo);
...
declare class __CFTree {
  constructor(init?: __CFTree);
}

declare class CFGregorianDate {
  constructor(init?: CFGregorianDate);
  year: number;
  month: number;
  day: number;
  hour: number;
...
declare class __CFXMLNode {
  constructor(init?: __CFXMLNode);
}
...
declare class CFXMLDocumentTypeInfo {
  constructor(init?: CFXMLDocumentTypeInfo);
  externalID: CFXMLExternalID;
}
...
declare class CFStreamClientContext {
  constructor(init?: CFStreamClientContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare class FSRef {
  constructor(init?: FSRef);
  hidden: unknown /* const array */;
}

declare class __CFDate {
  constructor(init?: __CFDate);
}

declare class __CFNumberFormatter {
  constructor(init?: __CFNumberFormatter);
}
...
declare class __CFDictionary {
  constructor(init?: __CFDictionary);
}

declare class CFRunLoopObserverContext {
  constructor(init?: CFRunLoopObserverContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare class __CFAllocator {
  constructor(init?: __CFAllocator);
}

declare class CFFileDescriptorContext {
  constructor(init?: CFFileDescriptorContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare function CFNotificationCenterGetDistributedCenter(): interop.Pointer;
...
declare function CFURLCreateBookmarkDataFromAliasRecord(allocatorRef: interop.PointerConvertible, aliasRecordDataRef: interop.PointerConvertible): interop.Pointer;
...
declare function CFBundleIsExecutableLoadable(bundle: interop.PointerConvertible): number;

declare function CFBundleIsExecutableLoadableForURL(url: interop.PointerConvertible): number;

declare function CFBundleIsArchitectureLoadable(arch: number): number;

declare function CFBundleGetPlugIn(bundle: interop.PointerConvertible): interop.Pointer;

declare function CFBundleOpenBundleResourceMap(bundle: interop.PointerConvertible): number;

declare function CFBundleOpenBundleResourceFiles(bundle: interop.PointerConvertible, refNum: interop.PointerConvertible, localizedRefNum: interop.PointerConvertible): number;

declare function CFBundleCloseBundleResourceMap(bundle: interop.PointerConvertible, refNum: number): void;
...
declare function CFUserNotificationCreate(allocator: interop.PointerConvertible, timeout: number, flags: number, error: interop.PointerConvertible, dictionary: interop.PointerConvertible): interop.Pointer;

declare function CFUserNotificationReceiveResponse(userNotification: interop.PointerConvertible, timeout: number, responseFlags: interop.PointerConvertible): number;

declare function CFUserNotificationGetResponseValue(userNotification: interop.PointerConvertible, key: interop.PointerConvertible, idx: number): interop.Pointer;

declare function CFUserNotificationGetResponseDictionary(userNotification: interop.PointerConvertible): interop.Pointer;

declare function CFUserNotificationUpdate(userNotification: interop.PointerConvertible, timeout: number, flags: number, dictionary: interop.PointerConvertible): number;

declare function CFUserNotificationCancel(userNotification: interop.PointerConvertible): number;

declare function CFUserNotificationCreateRunLoopSource(allocator: interop.PointerConvertible, userNotification: interop.PointerConvertible, callout: (p1: interop.PointerConvertible, p2: number) => void, order: number): interop.Pointer;

declare function CFUserNotificationDisplayNotice(timeout: number, flags: number, iconURL: interop.PointerConvertible, soundURL: interop.PointerConvertible, localizationURL: interop.PointerConvertible, alertHeader: interop.PointerConvertible, alertMessage: interop.PointerConvertible, defaultButtonTitle: interop.PointerConvertible): number;

declare function CFUserNotificationDisplayAlert(timeout: number, flags: number, iconURL: interop.PointerConvertible, soundURL: interop.PointerConvertible, localizationURL: interop.PointerConvertible, alertHeader: interop.PointerConvertible, alertMessage: interop.PointerConvertible, defaultButtonTitle: interop.PointerConvertible, alternateButtonTitle: interop.PointerConvertible, otherButtonTitle: interop.PointerConvertible, responseFlags: interop.PointerConvertible): number;

declare function CFXMLNodeGetTypeID(): number;

declare function CFXMLNodeCreate(alloc: interop.PointerConvertible, xmlType: interop.Enum<typeof CFXMLNodeTypeCode>, dataString: interop.PointerConvertible, additionalInfoPtr: interop.PointerConvertible, version: number): interop.Pointer;

declare function CFXMLNodeCreateCopy(alloc: interop.PointerConvertible, origNode: interop.PointerConvertible): interop.Pointer;

declare function CFXMLNodeGetTypeCode(node: interop.PointerConvertible): interop.Enum<typeof CFXMLNodeTypeCode>;

declare function CFXMLNodeGetString(node: interop.PointerConvertible): interop.Pointer;

declare function CFXMLNodeGetInfoPtr(node: interop.PointerConvertible): interop.Pointer;

declare function CFXMLNodeGetVersion(node: interop.PointerConvertible): number;

declare function CFXMLTreeCreateWithNode(allocator: interop.PointerConvertible, node: interop.PointerConvertible): interop.Pointer;

declare function CFXMLTreeGetNode(xmlTree: interop.PointerConvertible): interop.Pointer;

declare function CFXMLParserGetTypeID(): number;

declare function CFXMLParserCreate(allocator: interop.PointerConvertible, xmlData: interop.PointerConvertible, dataSource: interop.PointerConvertible, parseOptions: number, versionOfNodes: number, callBacks: interop.PointerConvertible, context: interop.PointerConvertible): interop.Pointer;

declare function CFXMLParserCreateWithDataFromURL(allocator: interop.PointerConvertible, dataSource: interop.PointerConvertible, parseOptions: number, versionOfNodes: number, callBacks: interop.PointerConvertible, context: interop.PointerConvertible): interop.Pointer;

declare function CFXMLParserGetContext(parser: interop.PointerConvertible, context: interop.PointerConvertible): void;

declare function CFXMLParserGetCallBacks(parser: interop.PointerConvertible, callBacks: interop.PointerConvertible): void;

declare function CFXMLParserGetSourceURL(parser: interop.PointerConvertible): interop.Pointer;

declare function CFXMLParserGetLocation(parser: interop.PointerConvertible): number;

declare function CFXMLParserGetLineNumber(parser: interop.PointerConvertible): number;

declare function CFXMLParserGetDocument(parser: interop.PointerConvertible): interop.Pointer;

declare function CFXMLParserGetStatusCode(parser: interop.PointerConvertible): interop.Enum<typeof CFXMLParserStatusCode>;

declare function CFXMLParserCopyErrorDescription(parser: interop.PointerConvertible): interop.Pointer;

declare function CFXMLParserAbort(parser: interop.PointerConvertible, errorCode: interop.Enum<typeof CFXMLParserStatusCode>, errorDescription: interop.PointerConvertible): void;

declare function CFXMLParserParse(parser: interop.PointerConvertible): number;

declare function CFXMLTreeCreateFromData(allocator: interop.PointerConvertible, xmlData: interop.PointerConvertible, dataSource: interop.PointerConvertible, parseOptions: number, versionOfNodes: number): interop.Pointer;

declare function CFXMLTreeCreateFromDataWithError(allocator: interop.PointerConvertible, xmlData: interop.PointerConvertible, dataSource: interop.PointerConvertible, parseOptions: number, versionOfNodes: number, errorDict: interop.PointerConvertible): interop.Pointer;

declare function CFXMLTreeCreateWithDataFromURL(allocator: interop.PointerConvertible, dataSource: interop.PointerConvertible, parseOptions: number, versionOfNodes: number): interop.Pointer;

declare function CFXMLTreeCreateXMLData(allocator: interop.PointerConvertible, xmlTree: interop.PointerConvertible): interop.Pointer;

declare function CFXMLCreateStringByEscapingEntities(allocator: interop.PointerConvertible, string: interop.PointerConvertible, entitiesDictionary: interop.PointerConvertible): interop.Pointer;

declare function CFXMLCreateStringByUnescapingEntities(allocator: interop.PointerConvertible, string: interop.PointerConvertible, entitiesDictionary: interop.PointerConvertible): interop.Pointer;
