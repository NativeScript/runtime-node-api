...
const ffi_h_arm64 = await Deno.readTextFile(
  "build_macosx-arm64/include/ffi.h",
);
const ffi_h_x86_64 = await Deno.readTextFile(
  "build_macosx-x86_64/include/ffi.h",
);
const ffitarget_h_arm64 = await Deno.readTextFile(
  "build_macosx-arm64/include/ffitarget.h",
);
const ffitarget_h_x86_64 = await Deno.readTextFile(
  "build_macosx-x86_64/include/ffitarget.h",
);
...
await Deno.writeTextFile(
  "build_macosx-universal/include/ffi.h",
  ffi_h_universal,
);

await Deno.writeTextFile(
  "build_macosx-universal/include/ffitarget.h",
