...
declare const kUTTypeAppleICNS: interop.Pointer;
...
declare const kMDAttributeType: interop.Pointer;
...
declare const kMDItemTextContent: interop.Pointer;
...
declare const kMDItemOriginalSource: interop.Pointer;
...
declare const kUTTypeUTF8TabSeparatedText: interop.Pointer;
...
declare const kMDItemMusicalInstrumentName: interop.Pointer;
...
declare const kUTTypeEmailMessage: interop.Pointer;
...
declare const kMDAttributeName: interop.Pointer;

declare const kMDAttributeReadOnlyValues: interop.Pointer;
...
declare const kMDQueryProgressNotification: interop.Pointer;

declare const kMDItemApplicationCategories: interop.Pointer;

declare const tokReserved: number;

declare const kMDItemLabelID: interop.Pointer;

declare const kMDItemURL: interop.Pointer;

declare const kMDItemRecipientAddresses: interop.Pointer;

declare const kMDItemRecipientEmailAddresses: interop.Pointer;

declare const kMDItemPerformers: interop.Pointer;

declare const kMDItemGenre: interop.Pointer;

declare const seekErr: number;

declare const kMDItemDirector: interop.Pointer;
...
declare const kMDItemCFBundleIdentifier: interop.Pointer;

declare const fsRdPerm: number;

declare const kUCCollateWidthInsensitiveMask: number;

declare const kMDItemMusicalInstrumentCategory: interop.Pointer;

declare const kMDItemAppleLoopsRootKey: interop.Pointer;

declare const kMDItemFinderComment: interop.Pointer;
...
declare const kMDItemInstantMessageAddresses: interop.Pointer;

declare const kMDItemEmailAddresses: interop.Pointer;

declare const kMDItemPhoneNumbers: interop.Pointer;

declare const errAEReplyNotValid: number;

declare const kMDItemEncodingApplications: interop.Pointer;

declare const kMDItemCreator: interop.Pointer;

declare const kFSReplaceObjectDefaultOptions: number;

declare const kMDItemSecurityMethod: interop.Pointer;

declare const kAEEquals: number;

declare const kMDItemPageHeight: interop.Pointer;

declare const kMDItemTheme: interop.Pointer;

declare const kAEISPostArgs: number;

declare const kMDItemContributors: interop.Pointer;

declare const kMDItemRecordingDate: interop.Pointer;

declare const pKeystrokeKey: number;

declare const kMDItemAudioTrackNumber: interop.Pointer;
...
declare const kMDItemKeySignature: interop.Pointer;

declare const kMDItemTempo: interop.Pointer;
...
declare const kMDItemHTMLContent: interop.Pointer;

declare const kMDItemFSNodeCount: interop.Pointer;

declare const kMDItemFSLabel: interop.Pointer;

declare const kAEUTHasReturningParam: number;

declare const kMDItemFSInvisible: interop.Pointer;

declare const kMDItemFSIsStationery: interop.Pointer;

declare const kMDItemFSIsExtensionHidden: interop.Pointer;

declare const kMDItemFSHasCustomIcon: interop.Pointer;
...
declare const kMDItemFSExists: interop.Pointer;

declare const kMDItemFSContentChangeDate: interop.Pointer;

declare const cmInvalidSrcMap: number;

declare const cResErr: number;

declare const kMDItemFSCreationDate: interop.Pointer;
...
declare const kMDItemExposureTimeString: interop.Pointer;

declare const kMDItemExposureProgram: interop.Pointer;

declare const kMDItemMeteringMode: interop.Pointer;

declare const kMDItemHasAlphaChannel: interop.Pointer;

declare const kD0DispatchedCStackBased: number;

declare const codecWouldOffscreenErr: number;

declare const kMDItemAlbum: interop.Pointer;

declare const kMDItemAudioBitRate: interop.Pointer;

declare const kMDItemVideoBitRate: interop.Pointer;

declare const kMDItemStreamable: interop.Pointer;

declare const gestaltNewPtrReturnsZeroedMemoryBit: number;

declare const kMDQueryDidUpdateNotification: interop.Pointer;

declare const kMDItemGPSDateStamp: interop.Pointer;

declare const kMDItemGPSAreaInformation: interop.Pointer;

declare const kMDItemGPSProcessingMethod: interop.Pointer;

declare const kMDItemGPSDestDistance: interop.Pointer;

declare const fsSBDrCrDat: number;

declare const pFont: number;

declare const kMDItemGPSDestBearing: interop.Pointer;

declare const gestaltCRMAttr: number;

declare const kMDItemGPSDestLatitude: interop.Pointer;

declare const kMDItemGPSDOP: interop.Pointer;

declare const kMDItemGPSStatus: interop.Pointer;

declare const kMDItemNamedLocation: interop.Pointer;

declare const kMDItemGPSTrack: interop.Pointer;

declare const kAEWaitReply: number;

declare const couldntGetRequiredComponent: number;

declare const kMDItemLongitude: interop.Pointer;

declare const uppCallComponentGetMPWorkFunctionProcInfo: number;

declare const vmNoMoreFileViewsErr: number;

declare const kMDItemAltitude: interop.Pointer;

declare const kMDItemEXIFGPSVersion: interop.Pointer;

declare const dsNoExtsDisassembler: number;

declare const kMDItemCameraOwner: interop.Pointer;

declare const kMDItemExposureTimeSeconds: interop.Pointer;

declare const kMDItemResolutionHeightDPI: interop.Pointer;

declare const kMDItemAperture: interop.Pointer;

declare const gestaltATSUDirectAccess: number;

declare const kMDItemISOSpeed: interop.Pointer;

declare const kMDItemFocalLength: interop.Pointer;

declare const kMDItemPixelCount: interop.Pointer;

declare const kMDItemPixelWidth: interop.Pointer;

declare const openFolderIconResource: number;

declare const kMDAttributeAllValues: interop.Pointer;
...
declare const kMDItemDurationSeconds: interop.Pointer;

declare const kMDItemDateAdded: interop.Pointer;

declare const kMDItemContentModificationDate: interop.Pointer;

declare const kioFCBWriteBit: number;

declare const kMDItemContentCreationDate: interop.Pointer;

declare const kMDItemLensModel: interop.Pointer;
...
declare const kMDItemDownloadedDate: interop.Pointer;

declare const kMDItemAuthors: interop.Pointer;

declare const kMDItemContentTypeTree: interop.Pointer;

declare const kMDItemContentType: interop.Pointer;

declare const kUTTagClassNSPboardType: interop.Pointer;

declare const kUTTagClassMIMEType: interop.Pointer;

declare const kUCCharPropTypeDecimalDigitValue: number;

declare const kUTTagClassFilenameExtension: interop.Pointer;

declare const kUTTypeVersionKey: interop.Pointer;

declare const kUTTypeDescriptionKey: interop.Pointer;
...
declare const kUTTypeX509Certificate: interop.Pointer;

declare const kUTTypePKCS12: interop.Pointer;
...
declare const kUTTypeBzip2Archive: interop.Pointer;

declare const kUTTypeGNUZipArchive: interop.Pointer;

declare const kUTTypeSystemPreferencesPane: interop.Pointer;

declare const kUTTypeJavaArchive: interop.Pointer;

declare const kVCBFlagsVolumeDirtyMask: number;

declare const kUTTypeApplicationFile: interop.Pointer;

declare const kUTTypeApplicationBundle: interop.Pointer;

declare const kUTTypeFramework: interop.Pointer;

declare const kUTTypeXPCService: interop.Pointer;

declare const kUTTypeQuickLookGenerator: interop.Pointer;

declare const kUTTypePluginBundle: interop.Pointer;

declare const kUTTypePackage: interop.Pointer;

declare const kUTTypeVolume: interop.Pointer;

declare const kHandleLockedBit: number;

declare const kUTTypeAVIMovie: interop.Pointer;

declare const kUTTypeAppleProtectedMPEG4Video: interop.Pointer;
...
declare const kUTTypeMovie: interop.Pointer;

declare const kUTTypeAudiovisualContent: interop.Pointer;

declare const kUTTypeScalableVectorGraphics: interop.Pointer;

declare const kUTTypeBMP: interop.Pointer;
...
declare const kUTTypeJPEG2000: interop.Pointer;
...
declare const kUTTypeTXNTextAndMultimediaData: interop.Pointer;

declare const kUTTypePropertyList: interop.Pointer;

declare const kUTTypeJSON: interop.Pointer;

declare const kUTTypeRubyScript: interop.Pointer;

declare const kUTTypeJavaScript: interop.Pointer;
...
declare const kUTTypeXML: interop.Pointer;

declare const kUTTypeTabSeparatedText: interop.Pointer;
...
declare const kUTTypeURLBookmarkData: interop.Pointer;

declare const fExtraPercent: number;

declare const cmpAliasNoFlags: number;

declare const kMDQueryScopeComputerIndexed: interop.Pointer;

declare const kUTTypeExecutable: interop.Pointer;

declare const nsDrvErr: number;

declare const kUTTypeDirectory: interop.Pointer;

declare const kUTTypeData: interop.Pointer;

declare const kUTTypeDiskImage: interop.Pointer;

declare const kUTTypeItem: interop.Pointer;

declare const kLSQuarantineOriginURLKey: interop.Pointer;

declare const kUnicodeUTF32Format: number;

declare const kHIDNotEnoughMemoryErr: number;

declare const kLSQuarantineTypeInstantMessageAttachment: interop.Pointer;

declare const kLSQuarantineTypeKey: interop.Pointer;

declare const kLSQuarantineTimeStampKey: interop.Pointer;

declare const kLSQuarantineAgentBundleIdentifierKey: interop.Pointer;

declare const kLSQuarantineAgentNameKey: interop.Pointer;

declare const kLSLaunchInhibitBGOnly: number;

declare const kLSItemExtensionIsHidden: interop.Pointer;
...
declare const kUTTypeWaveformAudio: interop.Pointer;
...
declare const kMDItemMaxAperture: interop.Pointer;
...
declare const kMDItemWhereFroms: interop.Pointer;
...
declare const kMDItemPageWidth: interop.Pointer;
...
declare const kUTTypePlaylist: interop.Pointer;
...
declare const kSKSubstitutions: interop.Pointer;

declare const HDActivity: number;

declare const UsrActivity: number;

declare const kMDItemAppleLoopsKeyFilterType: interop.Pointer;
...
declare const kMDAttributeDisplayValues: interop.Pointer;
...
declare const kMDItemFSName: interop.Pointer;
...
declare const kCSIdentityGeneratePosixName: interop.Pointer;
...
declare const kCSIdentityErrorDomain: interop.Pointer;
...
declare const kMDQueryDidFinishNotification: interop.Pointer;
...
declare const kUTTagClassOSType: interop.Pointer;
...
declare const kUTTypeSymLink: interop.Pointer;
...
declare const kUTTypeM3UPlaylist: interop.Pointer;
...
declare const kMDItemCoverage: interop.Pointer;
...
declare const kUTTypePHPScript: interop.Pointer;
...
declare const kLSItemRoleHandlerDisplayName: interop.Pointer;
...
declare const kUTTypeOSAScript: interop.Pointer;
...
declare const kMDItemTitle: interop.Pointer;
...
declare const kLSItemFileCreator: interop.Pointer;
...
declare const kMDItemHeadline: interop.Pointer;
...
declare const kMDItemLayerNames: interop.Pointer;
...
declare const kLSQuarantineTypeOtherDownload: interop.Pointer;
...
declare const kAERemoteProcessProcessIDKey: interop.Pointer;

declare const kAERemoteProcessNameKey: interop.Pointer;

declare const kAERemoteProcessURLKey: interop.Pointer;
...
declare const kUTTypePerlScript: interop.Pointer;
...
declare const kMDItemIdentifier: interop.Pointer;
...
declare const kMDItemOrientation: interop.Pointer;
...
declare const kMDItemCodecs: interop.Pointer;
...
declare const kMDItemLastUsedDate: interop.Pointer;
...
declare const kMDItemGPSDifferental: interop.Pointer;
...
declare const kUTTypeMessage: interop.Pointer;
...
declare const kUTTypeBundle: interop.Pointer;
...
declare const kMDItemExecutablePlatform: interop.Pointer;
...
declare const kMDAttributeMultiValued: interop.Pointer;
...
declare const kMDItemTimeSignature: interop.Pointer;
...
declare const kLSLaunchHasUntrustedContents: number;
...
declare const kMDItemResolutionWidthDPI: interop.Pointer;
...
declare const kMDItemTimestamp: interop.Pointer;
...
declare const kFSOperationObjectsRemainingKey: interop.Pointer;

declare const kFSOperationTotalObjectsKey: interop.Pointer;

declare const kFSOperationBytesRemainingKey: interop.Pointer;

declare const evtNotEnb: number;

declare const kioACAccessGroupReadBit: number;

declare const kUTTypePythonScript: interop.Pointer;

declare const kDropFolderAliasType: number;

declare const kFSOperationBytesCompleteKey: interop.Pointer;

declare const kFBCnoSuchHit: number;

declare const kFSOperationTotalBytesKey: interop.Pointer;
...
declare const kUTTypeAudio: interop.Pointer;
...
declare const kMDQueryResultContentRelevance: interop.Pointer;
...
declare const kUTTypeIconFileKey: interop.Pointer;
...
declare const kUTTypeBinaryPropertyList: interop.Pointer;
...
declare const kMDItemBitsPerSample: interop.Pointer;
...
declare const kMDItemWhiteBalance: interop.Pointer;
...
declare const kUTTypeWindowsExecutable: interop.Pointer;
...
declare const kMDItemOriginalFormat: interop.Pointer;
...
declare const kLSLaunchStartClassic: number;
...
declare const kMDItemRecordingYear: interop.Pointer;
...
declare const gestaltCPUARMFamily: number;
...
declare const kFSOperationObjectsCompleteKey: interop.Pointer;

declare const kMDItemDeliveryType: interop.Pointer;
...
declare const kMDQueryUpdateAddedItems: interop.Pointer;
...
declare const kUTTypeCompositeContent: interop.Pointer;
...
declare const kLSLaunchInClassic: number;
...
declare const kUTTypeCPlusPlusSource: interop.Pointer;

declare const gestaltUSBCosmoANSIKbd: number;

declare const kSKMinTermLength: interop.Pointer;
...
declare const kLSQuarantineDataURLKey: interop.Pointer;
...
declare const kUTTypeText: interop.Pointer;
...
declare const kFSOperationThroughputKey: interop.Pointer;
...
declare const gestaltCPUARM64: number;
...
declare const kMDItemKeywords: interop.Pointer;
...
declare const kUTTypeAppleScript: interop.Pointer;
...
declare const kLSItemFileType: interop.Pointer;
...
declare const kUTTypeContact: interop.Pointer;
...
declare const kUTTypeShellScript: interop.Pointer;
...
declare const kMDItemGPSMapDatum: interop.Pointer;
...
declare const kSKMaximumTerms: interop.Pointer;
...
declare const kUTTypeCPlusPlusHeader: interop.Pointer;
...
declare const kTextEncodingUnicodeV13_0: number;
...
declare const kUTTypePNG: interop.Pointer;
...
declare const kLSItemIsInvisible: interop.Pointer;
...
declare const kSKStartTermChars: interop.Pointer;
...
declare const kMDItemLabelKind: interop.Pointer;
...
declare const kFSOperationUserVisibleObjectsRemainingKey: interop.Pointer;
...
declare const kUTTypeScript: interop.Pointer;
...
declare const platformArm64NativeEntryPoint: number;
...
declare const kMDItemGPSDestLongitude: interop.Pointer;
...
declare const kMDItemAuthorAddresses: interop.Pointer;
...
declare const kFSOperationUserVisibleObjectsCompleteKey: interop.Pointer;
...
declare const kUTType3DContent: interop.Pointer;
...
declare const kMDQueryScopeAllIndexed: interop.Pointer;
...
declare const kMDItemLatitude: interop.Pointer;
...
declare const kUTTypePDF: interop.Pointer;
...
declare const kMDItemPublishers: interop.Pointer;
...
declare const kMDItemGPSMeasureMode: interop.Pointer;
...
declare const kUTTypeMPEG4: interop.Pointer;
...
declare const kMDItemEXIFVersion: interop.Pointer;
...
declare const kAERemoteProcessUserIDKey: interop.Pointer;
...
declare const kMDItemAppleLoopDescriptors: interop.Pointer;
...
declare const kMDItemEditors: interop.Pointer;
...
declare const kUTTypeResolvable: interop.Pointer;
...
declare const kMDItemRedEyeOnOff: interop.Pointer;
...
declare const kMDItemDueDate: interop.Pointer;
...
declare const kMDQueryScopeNetwork: interop.Pointer;
...
declare const kUTTypeArchive: interop.Pointer;
...
declare const kMDItemKind: interop.Pointer;
...
declare const kMDItemIsGeneralMIDISequence: interop.Pointer;
...
declare const kMDItemTotalBitRate: interop.Pointer;
...
declare const kFSEventStreamCreateFlagFullHistory: number;
...
declare const kMDItemSupportFileType: interop.Pointer;
...
declare const kUTTypeWebArchive: interop.Pointer;
...
declare const kMDLabelAddedNotification: interop.Pointer;
...
declare const gestaltArm: number;
...
declare const kUTTypeDelimitedText: interop.Pointer;
...
declare const kLSLaunchNoParams: number;

declare const kNSLInsufficientSysVer: number;

declare const kUTTypeAssemblyLanguageSource: interop.Pointer;
...
declare const kMDItemMediaTypes: interop.Pointer;
...
declare const kMDItemAppleLoopsLoopMode: interop.Pointer;
...
declare const kUTTypeUTF16ExternalPlainText: interop.Pointer;
...
declare const kMDItemImageDirection: interop.Pointer;
...
declare const kUTTypeUTF8PlainText: interop.Pointer;
...
declare const kMDItemFSOwnerGroupID: interop.Pointer;
...
declare const kUTTypeFolder: interop.Pointer;
...
declare const kMDItemFlashOnOff: interop.Pointer;
...
declare const kUTTypeFileURL: interop.Pointer;
...
declare const kUTTypeCSource: interop.Pointer;
...
declare const kMDItemFNumber: interop.Pointer;
...
declare const kMDItemSpeed: interop.Pointer;
...
declare const kMDLabelRemovedNotification: interop.Pointer;

declare const kMDItemMusicalGenre: interop.Pointer;
...
declare const kMDItemNumberOfPages: interop.Pointer;
...
declare const kMDItemFSSize: interop.Pointer;
...
declare const kMDItemAcquisitionModel: interop.Pointer;
...
declare const kUTTypeLivePhoto: interop.Pointer;
...
declare const kUTTypeAudioInterchangeFileFormat: interop.Pointer;
...
declare const kUTTypeSwiftSource: interop.Pointer;
...
declare const kMDItemLanguages: interop.Pointer;
...
declare const kMDItemExposureMode: interop.Pointer;
...
declare const kMDItemAttributeChangeDate: interop.Pointer;
...
declare const kMDItemInformation: interop.Pointer;
...
declare const kMDItemRights: interop.Pointer;
...
declare const kMDItemIsApplicationManaged: interop.Pointer;
...
declare const LSAcceptanceFlags: {
  Default: 1,
  AllowLoginUI: 2,
};

declare const SKDocumentIndexState: {
  NotIndexed: 0,
  Indexed: 1,
  AddPending: 2,
  DeletePending: 3,
...
declare class unnamed_3319857183312372578 {
  constructor(init?: unnamed_3319857183312372578);
  era: number;
  year: number;
  month: number;
  day: number;
...
declare class LSApplicationParameters {
  constructor(init?: LSApplicationParameters);
  version: number;
...
declare class FSForkInfo {
  constructor(init?: FSForkInfo);
  flags: number;
  permissions: number;
  volume: number;
  reserved2: number;
...
declare class TokenRec {
  constructor(init?: TokenRec);
  theToken: number;
  position: string | null;
  length: number;
  stringPosition: interop.Pointer;
}

declare class OpaqueTextToUnicodeInfo {
  constructor(init?: OpaqueTextToUnicodeInfo);
}

declare class TextRange {
  constructor(init?: TextRange);
  fStart: number;
  fEnd: number;
  fHiliteStyle: number;
}

declare class Itl1ExtRec {
  constructor(init?: Itl1ExtRec);
  base: Intl1Rec;
  version: number;
  format: number;
  calendarCode: number;
  ...
  tables: unknown /* const array */;
}

declare class PEFImportedLibrary {
  constructor(init?: PEFImportedLibrary);
  nameOffset: number;
...
declare class ComponentResource {
  constructor(init?: ComponentResource);
...
declare class OpaqueMPNotificationID {
  constructor(init?: OpaqueMPNotificationID);
}

declare class FormatVersionChunk {
  constructor(init?: FormatVersionChunk);
  ckID: number;
  ckSize: number;
  timestamp: number;
}
...
declare class AIFFLoop {
  constructor(init?: AIFFLoop);
  playMode: number;
  beginLoop: number;
  endLoop: number;
}
...
declare class AEKeyDesc {
  constructor(init?: AEKeyDesc);
  descKey: number;
  descContent: AEDesc;
}

declare class FSPermissionInfo {
  constructor(init?: FSPermissionInfo);
  userID: number;
  groupID: number;
  reserved1: number;
  userAccess: number;
...
declare class LocalDateTime {
  constructor(init?: LocalDateTime);
  highSeconds: number;
  lowSeconds: number;
  fraction: number;
}

declare class CatPositionRec {
  constructor(init?: CatPositionRec);
  initialize: number;
  priv: unknown /* const array */;
}

declare class UCKeyStateTerminators {
  constructor(init?: UCKeyStateTerminators);
  keyStateTerminatorsFormat: number;
  keyStateTerminatorCount: number;
  keyStateTerminators: unknown /* const array */;
}

declare class CSIdentityClientContext {
  constructor(init?: CSIdentityClientContext);
  version: number;
...
declare class AEDesc {
  constructor(init?: AEDesc);
  descriptorType: number;
  dataHandle: interop.Pointer;
}

declare class FInfo {
  constructor(init?: FInfo);
  fdType: number;
  fdCreator: number;
  fdFlags: number;
  fdLocation: Point;
...
declare class OpaqueAEStreamRef {
  constructor(init?: OpaqueAEStreamRef);
}
...
declare class __SKSearch {
  constructor(init?: __SKSearch);
}

declare class __SKIndexDocumentIterator {
  constructor(init?: __SKIndexDocumentIterator);
}

declare class __SKIndex {
  constructor(init?: __SKIndex);
}

declare class ItlcRecord {
  constructor(init?: ItlcRecord);
  itlcSystem: number;
  itlcReserved: number;
  ...
  itlcSysFlags: number;
  itlcReserved4: unknown /* const array */;
}

declare class __MDLabel {
  constructor(init?: __MDLabel);
}

declare class MDQueryBatchingParams {
  constructor(init?: MDQueryBatchingParams);
...
declare class OpaqueIconRef {
  constructor(init?: OpaqueIconRef);
}

declare class Intl1Rec {
  constructor(init?: Intl1Rec);
  days: unknown /* const array */;
  months: unknown /* const array */;
  suppressDay: number;
  lngDateFmt: number;
  dayLeading0: number;
  abbrLen: number;
  st0: unknown /* const array */;
  st1: unknown /* const array */;
  st2: unknown /* const array */;
  st3: unknown /* const array */;
  st4: unknown /* const array */;
  intl1Vers: number;
  localRtn: unknown /* const array */;
}

declare class OpaqueMPCpuID {
  constructor(init?: OpaqueMPCpuID);
}

declare class SleepQRec {
  constructor(init?: SleepQRec);
  sleepQLink: interop.Pointer;
  sleepQType: number;
  sleepQProc: (p1: number, p2: interop.PointerConvertible) => number | null;
  sleepQFlags: number;
}

declare class OpaqueLSSharedFileListRef {
  constructor(init?: OpaqueLSSharedFileListRef);
}

declare class IconFamilyElement {
  constructor(init?: IconFamilyElement);
  elementType: number;
  elementSize: number;
  elementData: unknown /* const array */;
}

declare class __CSIdentityQuery {
  constructor(init?: __CSIdentityQuery);
}

declare class __DCSDictionary {
  constructor(init?: __DCSDictionary);
}

declare class AudioRecordingChunk {
  constructor(init?: AudioRecordingChunk);
  ckID: number;
  ckSize: number;
  AESChannelStatus: unknown /* const array */;
}

declare class WritingCode {
  constructor(init?: WritingCode);
  theScriptCode: number;
  theLangCode: number;
}

declare class OffsetArray {
  constructor(init?: OffsetArray);
  fNumOfOffsets: number;
  fOffset: unknown /* const array */;
}

declare class TextRangeArray {
  constructor(init?: TextRangeArray);
  fNumOfRanges: number;
...
declare class TECInternetNameRec {
  constructor(init?: TECInternetNameRec);
  offset: number;
  searchEncoding: TextEncodingRec;
  encodingNameLength: number;
  encodingName: unknown /* const array */;
}

declare class FSEventStreamContext {
  constructor(init?: FSEventStreamContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare class TECConverterContextRec {
  constructor(init?: TECConverterContextRec);
  pluginRec: string | null;
  sourceEncoding: number;
  destEncoding: number;
  reserved1: number;
  reserved2: number;
  bufferContext: TECBufferContextRec;
  contextRefCon: interop.Pointer;
  conversionProc: () => number | null;
  flushProc: () => number | null;
  clearContextInfoProc: () => number | null;
  options1: number;
  options2: number;
  pluginState: TECPluginStateRec;
}

declare class TECBufferContextRec {
  constructor(init?: TECBufferContextRec);
  textInputBuffer: interop.Pointer;
  textInputBufferEnd: interop.Pointer;
  textOutputBuffer: interop.Pointer;
  textOutputBufferEnd: interop.Pointer;
  encodingInputBuffer: interop.Pointer;
  encodingInputBufferEnd: interop.Pointer;
  encodingOutputBuffer: interop.Pointer;
  encodingOutputBufferEnd: interop.Pointer;
}

declare class TECInternetNamesRec {
...
declare class CSIdentityQueryClientContext {
  constructor(init?: CSIdentityQueryClientContext);
  version: number;
  info: interop.Pointer;
  retainInfo: (p1: interop.PointerConvertible) => interop.Pointer | null;
  releaseInfo: (p1: interop.PointerConvertible) => void | null;
  copyInfoDescription: (p1: interop.PointerConvertible) => interop.Pointer | null;
  receiveEvent: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void | null;
}

declare class TECLocaleListToEncodingListRec {
  constructor(init?: TECLocaleListToEncodingListRec);
  offset: number;
  count: number;
  locales: number;
}

declare class TECEncodingPairRec {
  constructor(init?: TECEncodingPairRec);
  source: TextEncodingRec;
  dest: TextEncodingRec;
}

declare class IconFamilyResource {
  constructor(init?: IconFamilyResource);
  resourceType: number;
  resourceSize: number;
  elements: unknown /* const array */;
}

declare class TECSubTextEncodingRec {
  constructor(init?: TECSubTextEncodingRec);
  offset: number;
  searchEncoding: TextEncodingRec;
  count: number;
...
declare class UntokenTable {
  constructor(init?: UntokenTable);
  len: number;
  lastToken: number;
  index: unknown /* const array */;
}

declare class TECEncodingsListRec {
  constructor(init?: TECEncodingsListRec);
  count: number;
...
declare class ApplicationSpecificChunk {
  constructor(init?: ApplicationSpecificChunk);
  ckID: number;
  ckSize: number;
...
declare class BigEndianUnsignedLong {
  constructor(init?: BigEndianUnsignedLong);
  bigEndianValue: number;
}

declare class OpaqueWSMethodInvocationRef {
  constructor(init?: OpaqueWSMethodInvocationRef);
}

declare class ComponentPlatformInfoArray {
  constructor(init?: ComponentPlatformInfoArray);
  count: number;
  platformArray: unknown /* const array */;
}

declare class InstrumentChunk {
  constructor(init?: InstrumentChunk);
  ckID: number;
  ckSize: number;
...
declare class SoundDataChunk {
  constructor(init?: SoundDataChunk);
  ckID: number;
  ckSize: number;
  offset: number;
  blockSize: number;
...
declare class TextEncodingRec {
  constructor(init?: TextEncodingRec);
  base: number;
  variant: number;
  format: number;
}

declare class ExtCommonChunk {
  constructor(init?: ExtCommonChunk);
  ckID: number;
  ckSize: number;
  numChannels: number;
...
declare class ContainerChunk {
  constructor(init?: ContainerChunk);
  ckID: number;
  ckSize: number;
  formType: number;
}
...
declare class PEFExportedSymbolHashSlot {
  constructor(init?: PEFExportedSymbolHashSlot);
  countAndStart: number;
}

declare class PEFLoaderInfoHeader {
  constructor(init?: PEFLoaderInfoHeader);
  mainSection: number;
  mainOffset: number;
  initSection: number;
  initOffset: number;
...
declare class AVLTreeStruct {
  constructor(init?: AVLTreeStruct);
  signature: number;
  privateStuff: unknown /* const array */;
}

declare class MPAddressSpaceInfo {
  constructor(init?: MPAddressSpaceInfo);
  version: number;
  processID: interop.Pointer;
  groupID: interop.Pointer;
  nTasks: number;
  vsid: unknown /* const array */;
}

declare class LSItemInfoRecord {
  constructor(init?: LSItemInfoRecord);
...
declare class MPQueueInfo {
  constructor(init?: MPQueueInfo);
  version: number;
  processID: interop.Pointer;
  queueName: number;
  nWaiting: number;
...
declare class TECPluginDispatchTable {
  ...
  PluginID: number;
  PluginNewEncodingConverter: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => number | null;
  PluginClearContextInfo: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginConvertTextEncoding: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginFlushConversion: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginDisposeEncodingConverter: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginNewEncodingSniffer: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number | null;
  PluginClearSnifferContextInfo: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginSniffTextEncoding: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginDisposeEncodingSniffer: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
  PluginGetCountAvailableTextEncodings: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number | null;
  PluginGetCountAvailableTextEncodingPairs: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number | null;
  PluginGetCountDestinationTextEncodings: (p1: number, p2: interop.PointerConvertible, p3: number, p4: interop.PointerConvertible) => number | null;
  PluginGetCountSubTextEncodings: (p1: number, p2: interop.PointerConvertible, p3: number, p4: interop.PointerConvertible) => number | null;
  PluginGetCountAvailableSniffers: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number | null;
  PluginGetCountWebTextEncodings: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number | null;
  PluginGetCountMailTextEncodings: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number | null;
  PluginGetTextEncodingInternetName: (p1: number, p2: interop.PointerConvertible) => number | null;
  PluginGetTextEncodingFromInternetName: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number | null;
}

declare class TMTask {
  constructor(init?: TMTask);
  qLink: interop.Pointer;
  qType: number;
  tmAddr: (p1: interop.PointerConvertible) => void | null;
  tmCount: number;
  tmWakeUp: number;
  tmReserved: number;
}

declare class UnicodeMapping {
  constructor(init?: UnicodeMapping);
  unicodeEncoding: number;
  otherEncoding: number;
  mappingVersion: number;
}

declare class OpaqueUnicodeToTextInfo {
  constructor(init?: OpaqueUnicodeToTextInfo);
}

declare class ExtendedFolderInfo {
  constructor(init?: ExtendedFolderInfo);
...
declare class OpaqueTECSnifferObjectRef {
  constructor(init?: OpaqueTECSnifferObjectRef);
}

declare class SchedulerInfoRec {
  constructor(init?: SchedulerInfoRec);
  InfoRecSize: number;
...
declare class decform {
  constructor(init?: decform);
  style: number;
  unused: number;
  digits: number;
}

declare class unnamed_10627797838972045096 {
  constructor(init?: unnamed_10627797838972045096);
  length: number;
  text: unknown /* const array */;
  unused: number;
}
...
declare class decimal {
  ...
  unused: number;
  exp: number;
  sig: unnamed_10627797838972045096;
}

declare class OpaqueUCTypeSelectRef {
  constructor(init?: OpaqueUCTypeSelectRef);
}

declare class OpaqueCollatorRef {
  constructor(init?: OpaqueCollatorRef);
}

declare class __CSIdentityAuthority {
  constructor(init?: __CSIdentityAuthority);
}

declare class UCKeySequenceDataIndex {
  constructor(init?: UCKeySequenceDataIndex);
  keySequenceDataIndexFormat: number;
  charSequenceCount: number;
  charSequenceOffsets: unknown /* const array */;
}

declare class ComponentResourceExtension {
  constructor(init?: ComponentResourceExtension);
  componentVersion: number;
  componentRegisterFlags: number;
  componentIconFamily: number;
}

declare class TableDirectoryRecord {
  constructor(init?: TableDirectoryRecord);
...
declare class OpaqueMPCriticalRegionID {
  constructor(init?: OpaqueMPCriticalRegionID);
}

declare class unnamed_11385976894652822806 {
  constructor(init?: unnamed_11385976894652822806);
  lLow: number;
  lHigh: number;
}

declare class ExceptionInformationPowerPC {
  constructor(init?: ExceptionInformationPowerPC);
  theKind: number;
  machineState: interop.Pointer;
  registerImage: interop.Pointer;
...
declare class MachineInformationPowerPC {
  constructor(init?: MachineInformationPowerPC);
  CTR: UnsignedWide;
  LR: UnsignedWide;
  PC: UnsignedWide;
  CRRegister: number;
...
declare class LocaleAndVariant {
  constructor(init?: LocaleAndVariant);
  locale: interop.Pointer;
  opVariant: number;
}
...
declare class FSAliasInfo {
  ...
  filesystemID: number;
  signature: number;
  volumeIsBootVolume: number;
  volumeIsAutomounted: number;
  volumeIsEjectable: number;
  volumeHasPersistentFileIDs: number;
  isDirectory: number;
}

declare class BigEndianLong {
  constructor(init?: BigEndianLong);
  bigEndianValue: number;
}

declare class AliasRecord {
  constructor(init?: AliasRecord);
  hidden: unknown /* const array */;
}

declare class TECEncodingPairsRec {
  constructor(init?: TECEncodingPairsRec);
  count: number;
  encodingPairs: TECEncodingPairs;
}

declare class OpaqueFSVolumeOperation {
  constructor(init?: OpaqueFSVolumeOperation);
}

declare class NumFormatString {
  constructor(init?: NumFormatString);
  fLength: number;
  fVersion: number;
  data: unknown /* const array */;
}
...
declare class Itl5Record {
  constructor(init?: Itl5Record);
  versionNumber: number;
  numberOfTables: number;
  reserved: unknown /* const array */;
  tableDirectory: unknown /* const array */;
}

declare class CustomBadgeResource {
  constructor(init?: CustomBadgeResource);
  version: number;
...
declare class MPTaskInfoVersion2 {
  constructor(init?: MPTaskInfoVersion2);
  version: number;
  name: number;
  queueName: number;
  runState: number;
  ...
  preemptions: number;
  cpuID: interop.Pointer;
}

declare class OpaqueMPAreaID {
  constructor(init?: OpaqueMPAreaID);
}

declare class OpaqueMPEventID {
...
declare class OpaqueMPTaskID {
  constructor(init?: OpaqueMPTaskID);
}

declare class BigEndianUnsignedFixed {
  constructor(init?: BigEndianUnsignedFixed);
  bigEndianValue: number;
}

declare class TECSnifferContextRec {
  constructor(init?: TECSnifferContextRec);
  pluginRec: string | null;
  encoding: number;
  maxErrors: number;
  maxFeatures: number;
...
declare class OpaqueFSIterator {
  constructor(init?: OpaqueFSIterator);
}

declare class ComponentMPWorkFunctionHeaderRecord {
  constructor(init?: ComponentMPWorkFunctionHeaderRecord);
  headerSize: number;
  recordSize: number;
  workFlags: number;
...
declare class RegisteredComponentInstanceRecord {
  constructor(init?: RegisteredComponentInstanceRecord);
  data: unknown /* const array */;
}

declare class RegisteredComponentRecord {
  constructor(init?: RegisteredComponentRecord);
  data: unknown /* const array */;
}

declare class ComponentInstanceRecord {
  constructor(init?: ComponentInstanceRecord);
  data: unknown /* const array */;
}
...
declare class FSForkIOParam {
  constructor(init?: FSForkIOParam);
  qLink: interop.Pointer;
  qType: number;
  ioTrap: number;
...
declare class PEFContainerHeader {
  constructor(init?: PEFContainerHeader);
  tag1: number;
  tag2: number;
  architecture: number;
...
declare class ComponentAliasResource {
  constructor(init?: ComponentAliasResource);
  cr: ComponentResource;
  aliasCD: ComponentDescription;
}

declare class ExtComponentResource {
  constructor(init?: ExtComponentResource);
  cd: ComponentDescription;
  component: ResourceSpec;
  componentName: ResourceSpec;
  componentInfo: ResourceSpec;
...
declare class __CSIdentity {
  constructor(init?: __CSIdentity);
}

declare class FSForkCBInfoParam {
  constructor(init?: FSForkCBInfoParam);
  qLink: interop.Pointer;
  qType: number;
  ioTrap: number;
  ioCmdAddr: string | null;
  ...
  actualRefNum: number;
  ref: interop.Pointer;
  forkInfo: interop.Pointer;
  forkName: interop.Pointer;
}

declare class OpaqueTextBreakLocatorRef {
  constructor(init?: OpaqueTextBreakLocatorRef);
}

declare class XLibContainerHeader {
  constructor(init?: XLibContainerHeader);
  tag1: number;
  tag2: number;
...
declare class ComponentDescription {
  constructor(init?: ComponentDescription);
...
declare class FSSearchParams {
  constructor(init?: FSSearchParams);
  searchTime: number;
  searchBits: number;
  searchNameLength: number;
  searchName: interop.Pointer;
  searchInfo1: interop.Pointer;
  searchInfo2: interop.Pointer;
}

declare class ccntTokenRecord {
  constructor(init?: ccntTokenRecord);
  tokenClass: number;
  token: AEDesc;
}

declare class __FSFileSecurity {
  constructor(init?: __FSFileSecurity);
}

declare class FSRangeLockParam {
  constructor(init?: FSRangeLockParam);
  qLink: interop.Pointer;
  qType: number;
  ioTrap: number;
  ioCmdAddr: string | null;
...
declare class __FSFileOperation {
  constructor(init?: __FSFileOperation);
}

declare class WideCharArr {
  constructor(init?: WideCharArr);
  size: number;
  data: unknown /* const array */;
}

declare class Comment {
  constructor(init?: Comment);
  timeStamp: number;
  marker: number;
  count: number;
  text: unknown /* const array */;
...
declare class unnamed_10856951495104779945 {
  constructor(init?: unnamed_10856951495104779945);
  eraAlt: number;
  oldDate: DateTimeRec;
}

declare class Itl4Rec {
  constructor(init?: Itl4Rec);
  flags: number;
  resourceType: number;
  resourceNum: number;
  version: number;
...
declare class MPTaskInfo {
  ...
  preemptions: number;
  cpuID: interop.Pointer;
  blockedObject: interop.Pointer;
  spaceID: interop.Pointer;
  stackBase: interop.Pointer;
  stackLimit: interop.Pointer;
  stackCurr: interop.Pointer;
}

declare class BigEndianUInt32 {
  constructor(init?: BigEndianUInt32);
  bigEndianValue: number;
}

declare class PEFExportedSymbolKey {
  constructor(init?: PEFExportedSymbolKey);
  u: unnamed_11882119637946513298;
}

declare class BigEndianUnsignedShort {
  constructor(init?: BigEndianUnsignedShort);
  bigEndianValue: number;
}

declare class BigEndianOSType {
  constructor(init?: BigEndianOSType);
  bigEndianValue: number;
}

declare class BigEndianShort {
  constructor(init?: BigEndianShort);
  bigEndianValue: number;
}
...
declare class MixedModeStateRecord {
  constructor(init?: MixedModeStateRecord);
  state1: number;
  state2: number;
  state3: number;
  state4: number;
...
declare class VolumeMountInfoHeader {
  constructor(init?: VolumeMountInfoHeader);
  length: number;
  media: number;
  flags: number;
}
...
declare class TECInfo {
  ...
  tecTextEncodingsFolderName: unknown /* const array */;
...
declare class ScriptCodeRun {
  constructor(init?: ScriptCodeRun);
  offset: number;
  script: number;
}

declare class MachineLocation {
  constructor(init?: MachineLocation);
  latitude: number;
  longitude: number;
  u: unnamed_4659627061426497323;
}

declare class FSSpec {
  constructor(init?: FSSpec);
  hidden: unknown /* const array */;
}

declare class TECPluginStateRec {
  constructor(init?: TECPluginStateRec);
  state1: number;
  state2: number;
  state3: number;
  state4: number;
...
declare class TokenBlock {
  constructor(init?: TokenBlock);
  source: string | null;
  sourceLength: number;
  ...
  doString: number;
  doAppend: number;
  doAlphanumeric: number;
  doNest: number;
  leftDelims: unknown /* const array */;
  rightDelims: unknown /* const array */;
  leftComment: unknown /* const array */;
  rightComment: unknown /* const array */;
  escapeCode: number;
  decimalCode: number;
  itlResource: interop.Pointer;
  reserved: unknown /* const array */;
}

declare class FSVolumeInfo {
  constructor(init?: FSVolumeInfo);
...
declare class MemoryExceptionInformation {
  constructor(init?: MemoryExceptionInformation);
  theArea: interop.Pointer;
  theAddress: interop.Pointer;
  theError: number;
  theReference: number;
}

declare class OpaqueMPOpaqueID {
...
declare class unnamed_7690036363478627120 {
  constructor(init?: unnamed_7690036363478627120);
  lo: number;
  hi: number;
}
...
declare class Intl0Rec {
  constructor(init?: Intl0Rec);
  decimalPt: number;
  thousSep: number;
  listSep: number;
  currSym1: number;
  ...
  timeCycle: number;
  timeFmt: number;
  mornStr: unknown /* const array */;
  eveStr: unknown /* const array */;
  timeSep: number;
  time1Suff: number;
  time2Suff: number;
  time3Suff: number;
...
declare class RuleBasedTrslRecord {
  constructor(init?: RuleBasedTrslRecord);
  sourceType: number;
  targetType: number;
  formatNumber: number;
  propertyFlag: number;
...
declare class OffPair {
  constructor(init?: OffPair);
  offFirst: number;
  offSecond: number;
}

declare class unnamed_2879938362726788254 {
  constructor(init?: unnamed_2879938362726788254);
  pad: unknown /* const array */;
  Delta: number;
}

declare class NumberParts {
  constructor(init?: NumberParts);
  version: number;
  data: unknown /* const array */;
  pePlus: WideCharArr;
  peMinus: WideCharArr;
...
declare class FSCatalogBulkParam {
  constructor(init?: FSCatalogBulkParam);
  qLink: interop.Pointer;
  qType: number;
  ioTrap: number;
  ioCmdAddr: string | null;
  ioCompletion: (p1: interop.PointerConvertible) => void | null;
  ioResult: number;
  containerChanged: number;
  reserved: number;
  iteratorFlags: number;
  iterator: interop.Pointer;
  container: interop.Pointer;
  maximumItems: number;
  actualItems: number;
  whichInfo: number;
  catalogInfo: interop.Pointer;
  refs: interop.Pointer;
  specs: interop.Pointer;
  names: interop.Pointer;
  searchParams: interop.Pointer;
}

declare class OpaqueMPCoherenceID {
...
declare class FXInfo {
  ...
  fdIconID: number;
  fdReserved: unknown /* const array */;
  fdScript: number;
  fdXFlags: number;
  fdComment: number;
  fdPutAway: number;
...
declare class FSFileOperationClientContext {
  constructor(init?: FSFileOperationClientContext);
  version: number;
  info: interop.Pointer;
  retain: (p1: interop.PointerConvertible) => interop.Pointer | null;
  release: (p1: interop.PointerConvertible) => void | null;
...
declare class AFPVolMountInfo {
  constructor(init?: AFPVolMountInfo);
  length: number;
  media: number;
  flags: number;
  nbpInterval: number;
...
declare class FolderInfo {
  constructor(init?: FolderInfo);
  windowBounds: Rect;
  finderFlags: number;
  location: Point;
  reservedField: number;
...
declare class GetVolParmsInfoBuffer {
  constructor(init?: GetVolParmsInfoBuffer);
  vMVersion: number;
  vMAttrib: number;
  vMLocalHand: interop.Pointer;
  vMServerAdr: number;
  vMVolumeGrade: number;
  vMForeignPrivID: number;
  vMExtendedAttributes: number;
  vMDeviceID: interop.Pointer;
...
declare class __SKSummary {
  constructor(init?: __SKSummary);
}

declare class ExtendedFileInfo {
  constructor(init?: ExtendedFileInfo);
...
declare class DeferredTask {
  constructor(init?: DeferredTask);
  qLink: interop.Pointer;
  qType: number;
  dtFlags: number;
  dtAddr: (p1: number) => void | null;
  dtParam: number;
  dtReserved: number;
}

declare class UTCDateTime {
  constructor(init?: UTCDateTime);
  highSeconds: number;
  lowSeconds: number;
  fraction: number;
}

declare class MPNotificationInfo {
  constructor(init?: MPNotificationInfo);
  version: number;
  processID: interop.Pointer;
  notificationName: number;
  queueID: interop.Pointer;
  p1: interop.Pointer;
  p2: interop.Pointer;
  p3: interop.Pointer;
  eventID: interop.Pointer;
  events: number;
  semaphoreID: interop.Pointer;
}

declare class QHdr {
  constructor(init?: QHdr);
  qFlags: number;
  qHead: interop.Pointer;
  qTail: interop.Pointer;
}

declare class UCKeyStateRecordsIndex {
  constructor(init?: UCKeyStateRecordsIndex);
  keyStateRecordsIndexFormat: number;
  keyStateRecordCount: number;
  keyStateRecordOffsets: unknown /* const array */;
}

declare class TScriptingSizeResource {
  constructor(init?: TScriptingSizeResource);
...
declare class MarkerChunk {
  constructor(init?: MarkerChunk);
  ckID: number;
  ckSize: number;
  numMarkers: number;
...
declare class FSCatalogInfo {
  ...
  finderInfo: unknown /* const array */;
  extFinderInfo: unknown /* const array */;
...
declare class MPCriticalRegionInfo {
  constructor(init?: MPCriticalRegionInfo);
  version: number;
  processID: interop.Pointer;
  regionName: number;
  nWaiting: number;
  waitingTaskID: interop.Pointer;
  owningTask: interop.Pointer;
  count: number;
}

declare class ItlbRecord {
  constructor(init?: ItlbRecord);
  itlbNumber: number;
  itlbDate: number;
  itlbSort: number;
  itlbFlags: number;
...
declare class OpaqueCollection {
  constructor(init?: OpaqueCollection);
}

declare class MIDIDataChunk {
  constructor(init?: MIDIDataChunk);
  ckID: number;
  ckSize: number;
  MIDIdata: unknown /* const array */;
}

declare class UCKeyStateRecord {
  constructor(init?: UCKeyStateRecord);
  stateZeroCharData: number;
  stateZeroNextState: number;
  stateEntryCount: number;
  stateEntryFormat: number;
  stateEntryData: unknown /* const array */;
}

declare class UCKeyModifiersToTableNum {
  constructor(init?: UCKeyModifiersToTableNum);
  keyModifiersToTableNumFormat: number;
  defaultTableNum: number;
  modifiersCount: number;
  tableNum: unknown /* const array */;
}

declare class AFPAlternateAddress {
  constructor(init?: AFPAlternateAddress);
  fVersion: number;
  fAddressCount: number;
  fAddressList: unknown /* const array */;
}

declare class PEFSectionHeader {
  constructor(init?: PEFSectionHeader);
  nameOffset: number;
...
declare class UCKeyToCharTableIndex {
  constructor(init?: UCKeyToCharTableIndex);
...
declare class CommentsChunk {
  ...
  ckSize: number;
  numComments: number;
  comments: unknown /* const array */;
}

declare class TECConversionInfo {
  constructor(init?: TECConversionInfo);
  sourceEncoding: number;
...
declare class ExceptionInformation {
  constructor(init?: ExceptionInformation);
  theKind: number;
  machineState: interop.Pointer;
  registerImage: interop.Pointer;
  FPUImage: interop.Pointer;
...
declare class TogglePB {
  constructor(init?: TogglePB);
  togFlags: number;
  amChars: number;
  pmChars: number;
  reserved: unknown /* const array */;
...
declare class NItl4Rec {
  constructor(init?: NItl4Rec);
  flags: number;
  resourceType: number;
  resourceNum: number;
  version: number;
...
declare class OpaqueTECObjectRef {
  constructor(init?: OpaqueTECObjectRef);
}

declare class ComponentPlatformInfo {
  constructor(init?: ComponentPlatformInfo);
  componentFlags: number;
  component: ResourceSpec;
  platformType: number;
}
...
type unnamed_11882119637946513298Descriptor = 
  | { fullHashWord: number }
  | { splitHashWord: PEFSplitHashWord };

declare class unnamed_11882119637946513298 {
  constructor(init?: unnamed_11882119637946513298Descriptor);
  fullHashWord: number;
  splitHashWord: PEFSplitHashWord;
}
...
declare class Vector128 {
  constructor(init?: Vector128Descriptor);
  l: unknown /* const array */;
  s: unknown /* const array */;
  c: unknown /* const array */;
}
...
type unnamed_4659627061426497323Descriptor = 
  | { gmtDelta: number }
  | { dls: unnamed_2879938362726788254 };

declare class unnamed_4659627061426497323 {
  constructor(init?: unnamed_4659627061426497323Descriptor);
  gmtDelta: number;
  dls: unnamed_2879938362726788254;
}

type LongDateRecDescriptor = 
  | { ld: unnamed_3319857183312372578 }
  | { list: unknown /* const array */ }
  | { od: unnamed_10856951495104779945 };
...
type LongDateCvtDescriptor = 
  | { c: number }
  | { hl: unnamed_11385976894652822806 };
...
declare function FixMul(a: number, b: number): number;

declare function FixRound(x: number): number;

declare function Fix2Frac(x: number): number;

declare function Fix2Long(x: number): number;

declare function Long2Fix(x: number): number;

declare function Frac2Fix(x: number): number;

declare function FracMul(x: number, y: number): number;

declare function FixDiv(x: number, y: number): number;

declare function FracDiv(x: number, y: number): number;

declare function FracSqrt(x: number): number;

declare function FracSin(x: number): number;

declare function FracCos(x: number): number;

declare function FixATan2(x: number, y: number): number;

declare function Frac2X(x: number): number;

declare function Fix2X(x: number): number;

declare function X2Fix(x: number): number;

declare function X2Frac(x: number): number;

declare function WideCompare(target: interop.PointerConvertible, source: interop.PointerConvertible): number;

declare function WideAdd(target: interop.PointerConvertible, source: interop.PointerConvertible): interop.Pointer;

declare function WideSubtract(target: interop.PointerConvertible, source: interop.PointerConvertible): interop.Pointer;

declare function WideNegate(target: interop.PointerConvertible): interop.Pointer;

declare function WideShift(target: interop.PointerConvertible, shift: number): interop.Pointer;

declare function WideSquareRoot(source: interop.PointerConvertible): number;

declare function WideMultiply(multiplicand: number, multiplier: number, target: interop.PointerConvertible): interop.Pointer;

declare function WideDivide(dividend: interop.PointerConvertible, divisor: number, remainder: interop.PointerConvertible): number;

declare function WideWideDivide(dividend: interop.PointerConvertible, divisor: number, remainder: interop.PointerConvertible): interop.Pointer;

declare function WideBitShift(target: interop.PointerConvertible, shift: number): interop.Pointer;

declare function UnsignedFixedMulDiv(value: number, multiplier: number, divisor: number): number;

declare function GetScriptManagerVariable(selector: number): number;

declare function SetScriptManagerVariable(selector: number, param: number): number;

declare function SysError(errorCode: number): void;
...
declare function GetTextEncodingName(iEncoding: number, iNamePartSelector: number, iPreferredRegion: number, iPreferredEncoding: number, iOutputBufLen: number, oNameLength: interop.PointerConvertible, oActualRegion: interop.PointerConvertible, oActualEncoding: interop.PointerConvertible, oEncodingName: interop.PointerConvertible): number;

declare function TECGetInfo(tecInfo: interop.PointerConvertible): number;

declare function UpgradeScriptInfoToTextEncoding(iTextScriptID: number, iTextLanguageID: number, iRegionID: number, iTextFontname: interop.PointerConvertible, oEncoding: interop.PointerConvertible): number;

declare function RevertTextEncodingToScriptInfo(iEncoding: number, oTextScriptID: interop.PointerConvertible, oTextLanguageID: interop.PointerConvertible, oTextFontname: unknown /* const array */): number;

declare function GetTextEncodingFromScriptInfo(iTextScriptID: number, iTextLanguageID: number, iTextRegionID: number, oEncoding: interop.PointerConvertible): number;

declare function GetScriptInfoFromTextEncoding(iEncoding: number, oTextScriptID: interop.PointerConvertible, oTextLanguageID: interop.PointerConvertible): number;

declare function NearestMacTextEncodings(generalEncoding: number, bestMacEncoding: interop.PointerConvertible, alternateMacEncoding: interop.PointerConvertible): number;

declare function UCGetCharProperty(charPtr: interop.PointerConvertible, textLength: number, propType: number, propValue: interop.PointerConvertible): number;

declare function NewCollectionFlattenUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function NewCollectionExceptionUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => number): (p1: interop.PointerConvertible, p2: number) => number;

declare function DisposeCollectionFlattenUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function DisposeCollectionExceptionUPP(userUPP: (p1: interop.PointerConvertible, p2: number) => number): void;

declare function InvokeCollectionFlattenUPP(size: number, data: interop.PointerConvertible, refCon: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function InvokeCollectionExceptionUPP(c: interop.PointerConvertible, status: number, userUPP: (p1: interop.PointerConvertible, p2: number) => number): number;

declare function NewCollection(): interop.Pointer;

declare function DisposeCollection(c: interop.PointerConvertible): void;

declare function CloneCollection(c: interop.PointerConvertible): interop.Pointer;

declare function CountCollectionOwners(c: interop.PointerConvertible): number;

declare function RetainCollection(c: interop.PointerConvertible): number;

declare function ReleaseCollection(c: interop.PointerConvertible): number;

declare function GetCollectionRetainCount(c: interop.PointerConvertible): number;

declare function CopyCollection(srcCollection: interop.PointerConvertible, dstCollection: interop.PointerConvertible): interop.Pointer;

declare function GetCollectionDefaultAttributes(c: interop.PointerConvertible): number;

declare function SetCollectionDefaultAttributes(c: interop.PointerConvertible, whichAttributes: number, newAttributes: number): void;

declare function CountCollectionItems(c: interop.PointerConvertible): number;

declare function AddCollectionItem(c: interop.PointerConvertible, tag: number, id: number, itemSize: number, itemData: interop.PointerConvertible): number;

declare function GetCollectionItem(c: interop.PointerConvertible, tag: number, id: number, itemSize: interop.PointerConvertible, itemData: interop.PointerConvertible): number;

declare function RemoveCollectionItem(c: interop.PointerConvertible, tag: number, id: number): number;

declare function SetCollectionItemInfo(c: interop.PointerConvertible, tag: number, id: number, whichAttributes: number, newAttributes: number): number;

declare function GetCollectionItemInfo(c: interop.PointerConvertible, tag: number, id: number, itemIndex: interop.PointerConvertible, itemSize: interop.PointerConvertible, attributes: interop.PointerConvertible): number;

declare function ReplaceIndexedCollectionItem(c: interop.PointerConvertible, itemIndex: number, itemSize: number, itemData: interop.PointerConvertible): number;

declare function GetIndexedCollectionItem(c: interop.PointerConvertible, itemIndex: number, itemSize: interop.PointerConvertible, itemData: interop.PointerConvertible): number;

declare function RemoveIndexedCollectionItem(c: interop.PointerConvertible, itemIndex: number): number;

declare function SetIndexedCollectionItemInfo(c: interop.PointerConvertible, itemIndex: number, whichAttributes: number, newAttributes: number): number;

declare function GetIndexedCollectionItemInfo(c: interop.PointerConvertible, itemIndex: number, tag: interop.PointerConvertible, id: interop.PointerConvertible, itemSize: interop.PointerConvertible, attributes: interop.PointerConvertible): number;

declare function CollectionTagExists(c: interop.PointerConvertible, tag: number): number;

declare function CountCollectionTags(c: interop.PointerConvertible): number;

declare function GetIndexedCollectionTag(c: interop.PointerConvertible, tagIndex: number, tag: interop.PointerConvertible): number;

declare function CountTaggedCollectionItems(c: interop.PointerConvertible, tag: number): number;

declare function GetTaggedCollectionItem(c: interop.PointerConvertible, tag: number, whichItem: number, itemSize: interop.PointerConvertible, itemData: interop.PointerConvertible): number;

declare function GetTaggedCollectionItemInfo(c: interop.PointerConvertible, tag: number, whichItem: number, id: interop.PointerConvertible, itemIndex: interop.PointerConvertible, itemSize: interop.PointerConvertible, attributes: interop.PointerConvertible): number;

declare function PurgeCollection(c: interop.PointerConvertible, whichAttributes: number, matchingAttributes: number): void;

declare function PurgeCollectionTag(c: interop.PointerConvertible, tag: number): void;

declare function EmptyCollection(c: interop.PointerConvertible): void;

declare function FlattenCollection(c: interop.PointerConvertible, flattenProc: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, refCon: interop.PointerConvertible): number;

declare function FlattenPartialCollection(c: interop.PointerConvertible, flattenProc: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, refCon: interop.PointerConvertible, whichAttributes: number, matchingAttributes: number): number;

declare function UnflattenCollection(c: interop.PointerConvertible, flattenProc: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, refCon: interop.PointerConvertible): number;

declare function GetCollectionExceptionProc(c: interop.PointerConvertible): (p1: interop.PointerConvertible, p2: number) => number;

declare function SetCollectionExceptionProc(c: interop.PointerConvertible, exceptionProc: (p1: interop.PointerConvertible, p2: number) => number): void;

declare function GetNewCollection(collectionID: number): interop.Pointer;

declare function AddCollectionItemHdl(aCollection: interop.PointerConvertible, tag: number, id: number, itemData: interop.PointerConvertible): number;

declare function GetCollectionItemHdl(aCollection: interop.PointerConvertible, tag: number, id: number, itemData: interop.PointerConvertible): number;

declare function ReplaceIndexedCollectionItemHdl(aCollection: interop.PointerConvertible, itemIndex: number, itemData: interop.PointerConvertible): number;

declare function GetIndexedCollectionItemHdl(aCollection: interop.PointerConvertible, itemIndex: number, itemData: interop.PointerConvertible): number;

declare function FlattenCollectionToHdl(aCollection: interop.PointerConvertible, flattened: interop.PointerConvertible): number;

declare function UnflattenCollectionFromHdl(aCollection: interop.PointerConvertible, flattened: interop.PointerConvertible): number;

declare function CoreEndianInstallFlipper(dataDomain: number, dataType: number, proc: (p1: number, p2: number, p3: number, p4: interop.PointerConvertible, p5: number, p6: number, p7: interop.PointerConvertible) => number, refcon: interop.PointerConvertible): number;

declare function CoreEndianGetFlipper(dataDomain: number, dataType: number, proc: interop.PointerConvertible, refcon: interop.PointerConvertible): number;

declare function CoreEndianFlipData(dataDomain: number, dataType: number, id: number, data: interop.PointerConvertible, dataLen: number, currentlyNative: number): number;

declare function Gestalt(selector: number, response: interop.PointerConvertible): number;

declare function NewGestaltValue(selector: number, newValue: number): number;

declare function ReplaceGestaltValue(selector: number, replacementValue: number): number;

declare function SetGestaltValue(selector: number, newValue: number): number;

declare function DeleteGestaltValue(selector: number): number;

declare function NewSelectorFunctionUPP(userRoutine: (p1: number, p2: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible) => number;

declare function DisposeSelectorFunctionUPP(userUPP: (p1: number, p2: interop.PointerConvertible) => number): void;

declare function InvokeSelectorFunctionUPP(selector: number, response: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible) => number): number;

declare function MemError(): number;

declare function LMGetMemErr(): number;

declare function LMSetMemErr(value: number): void;

declare function NewHandle(byteCount: number): interop.Pointer;

declare function NewHandleClear(byteCount: number): interop.Pointer;

declare function RecoverHandle(p: string): interop.Pointer;

declare function NewPtr(byteCount: number): string;

declare function NewPtrClear(byteCount: number): string;

declare function NewEmptyHandle(): interop.Pointer;

declare function HLock(h: interop.PointerConvertible): void;

declare function HLockHi(h: interop.PointerConvertible): void;

declare function HUnlock(h: interop.PointerConvertible): void;

declare function TempNewHandle(logicalSize: number, resultCode: interop.PointerConvertible): interop.Pointer;

declare function DisposePtr(p: string): void;

declare function GetPtrSize(p: string): number;

declare function SetPtrSize(p: string, newSize: number): void;

declare function DisposeHandle(h: interop.PointerConvertible): void;

declare function SetHandleSize(h: interop.PointerConvertible, newSize: number): void;

declare function GetHandleSize(h: interop.PointerConvertible): number;

declare function ReallocateHandle(h: interop.PointerConvertible, byteCount: number): void;

declare function EmptyHandle(h: interop.PointerConvertible): void;

declare function HSetRBit(h: interop.PointerConvertible): void;

declare function HClrRBit(h: interop.PointerConvertible): void;

declare function HGetState(h: interop.PointerConvertible): number;

declare function HSetState(h: interop.PointerConvertible, flags: number): void;

declare function HandToHand(theHndl: interop.PointerConvertible): number;

declare function PtrToXHand(srcPtr: interop.PointerConvertible, dstHndl: interop.PointerConvertible, size: number): number;

declare function PtrToHand(srcPtr: interop.PointerConvertible, dstHndl: interop.PointerConvertible, size: number): number;

declare function HandAndHand(hand1: interop.PointerConvertible, hand2: interop.PointerConvertible): number;

declare function PtrAndHand(ptr1: interop.PointerConvertible, hand2: interop.PointerConvertible, size: number): number;

declare function IsHeapValid(): number;

declare function IsHandleValid(h: interop.PointerConvertible): number;

declare function IsPointerValid(p: string): number;
...
declare function S64Divide(dividend: number, divisor: number, remainder: interop.PointerConvertible): number;
...
declare function S64And(left: number, right: number): number;

declare function S64Or(left: number, right: number): number;

declare function S64Eor(left: number, right: number): number;

declare function S64Not(value: number): number;

declare function S64Compare(left: number, right: number): number;
...
declare function U64Divide(dividend: number, divisor: number, remainder: interop.PointerConvertible): number;
...
declare function U64And(left: number, right: number): number;

declare function U64Or(left: number, right: number): number;

declare function U64Eor(left: number, right: number): number;

declare function U64Not(value: number): number;
...
declare function UCConvertSecondsToCFAbsoluteTime(iSeconds: number, oCFTime: interop.PointerConvertible): number;

declare function UCConvertLongDateTimeToCFAbsoluteTime(iLongTime: number, oCFTime: interop.PointerConvertible): number;

declare function UCConvertCFAbsoluteTimeToUTCDateTime(iCFTime: number, oUTCDate: interop.PointerConvertible): number;

declare function UCConvertCFAbsoluteTimeToSeconds(iCFTime: number, oSeconds: interop.PointerConvertible): number;

declare function UCConvertCFAbsoluteTimeToLongDateTime(iCFTime: number, oLongDate: interop.PointerConvertible): number;

declare function IsMetric(): number;

declare function Delay(numTicks: number, finalTicks: interop.PointerConvertible): void;

declare function Enqueue(qElement: interop.PointerConvertible, qHeader: interop.PointerConvertible): void;

declare function Dequeue(qElement: interop.PointerConvertible, qHeader: interop.PointerConvertible): number;

declare function ReadLocation(loc: interop.PointerConvertible): void;
...
declare function DisposeDeferredTaskUPP(userUPP: (p1: number) => void): void;

declare function InvokeDeferredTaskUPP(dtParam: number, userUPP: (p1: number) => void): void;

declare function NewIOCompletionUPP(userRoutine: (p1: interop.PointerConvertible) => void): (p1: interop.PointerConvertible) => void;

declare function DisposeIOCompletionUPP(userUPP: (p1: interop.PointerConvertible) => void): void;

declare function InvokeIOCompletionUPP(paramBlock: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => void): void;

declare function FSMakeFSRefUnicode(parentRef: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, textEncodingHint: number, newRef: interop.PointerConvertible): number;

declare function PBMakeFSRefUnicodeSync(paramBlock: interop.PointerConvertible): number;

declare function PBMakeFSRefUnicodeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCompareFSRefs(ref1: interop.PointerConvertible, ref2: interop.PointerConvertible): number;

declare function PBCompareFSRefsSync(paramBlock: interop.PointerConvertible): number;

declare function PBCompareFSRefsAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCreateFileUnicode(parentRef: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible, newRef: interop.PointerConvertible, newSpec: interop.PointerConvertible): number;

declare function PBCreateFileUnicodeSync(paramBlock: interop.PointerConvertible): number;

declare function PBCreateFileUnicodeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCreateDirectoryUnicode(parentRef: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible, newRef: interop.PointerConvertible, newSpec: interop.PointerConvertible, newDirID: interop.PointerConvertible): number;

declare function PBCreateDirectoryUnicodeSync(paramBlock: interop.PointerConvertible): number;

declare function PBCreateDirectoryUnicodeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSDeleteObject(ref: interop.PointerConvertible): number;

declare function PBDeleteObjectSync(paramBlock: interop.PointerConvertible): number;

declare function PBDeleteObjectAsync(paramBlock: interop.PointerConvertible): void;

declare function FSUnlinkObject(ref: interop.PointerConvertible): number;

declare function PBUnlinkObjectSync(paramBlock: interop.PointerConvertible): number;

declare function PBUnlinkObjectAsync(paramBlock: interop.PointerConvertible): void;

declare function FSMoveObject(ref: interop.PointerConvertible, destDirectory: interop.PointerConvertible, newRef: interop.PointerConvertible): number;

declare function PBMoveObjectSync(paramBlock: interop.PointerConvertible): number;

declare function PBMoveObjectAsync(paramBlock: interop.PointerConvertible): void;

declare function FSExchangeObjects(ref: interop.PointerConvertible, destRef: interop.PointerConvertible): number;

declare function PBExchangeObjectsSync(paramBlock: interop.PointerConvertible): number;
...
declare function FSPathGetTemporaryDirectoryForReplaceObject(originalObjectPath: string, temporaryDirectoryPath: string, maxPathSize: number, flags: number): number;

declare function FSRenameUnicode(ref: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, textEncodingHint: number, newRef: interop.PointerConvertible): number;

declare function PBRenameUnicodeSync(paramBlock: interop.PointerConvertible): number;

declare function PBRenameUnicodeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSGetCatalogInfo(ref: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible, outName: interop.PointerConvertible, fsSpec: interop.PointerConvertible, parentRef: interop.PointerConvertible): number;

declare function PBGetCatalogInfoSync(paramBlock: interop.PointerConvertible): number;

declare function PBGetCatalogInfoAsync(paramBlock: interop.PointerConvertible): void;

declare function FSSetCatalogInfo(ref: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible): number;

declare function PBSetCatalogInfoSync(paramBlock: interop.PointerConvertible): number;

declare function PBSetCatalogInfoAsync(paramBlock: interop.PointerConvertible): void;

declare function FSOpenIterator(container: interop.PointerConvertible, iteratorFlags: number, iterator: interop.PointerConvertible): number;

declare function PBOpenIteratorSync(paramBlock: interop.PointerConvertible): number;

declare function PBOpenIteratorAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCloseIterator(iterator: interop.PointerConvertible): number;

declare function PBCloseIteratorSync(paramBlock: interop.PointerConvertible): number;

declare function PBCloseIteratorAsync(paramBlock: interop.PointerConvertible): void;

declare function FSGetCatalogInfoBulk(iterator: interop.PointerConvertible, maximumObjects: number, actualObjects: interop.PointerConvertible, containerChanged: interop.PointerConvertible, whichInfo: number, catalogInfos: interop.PointerConvertible, refs: interop.PointerConvertible, specs: interop.PointerConvertible, names: interop.PointerConvertible): number;

declare function PBGetCatalogInfoBulkSync(paramBlock: interop.PointerConvertible): number;

declare function PBGetCatalogInfoBulkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCatalogSearch(iterator: interop.PointerConvertible, searchCriteria: interop.PointerConvertible, maximumObjects: number, actualObjects: interop.PointerConvertible, containerChanged: interop.PointerConvertible, whichInfo: number, catalogInfos: interop.PointerConvertible, refs: interop.PointerConvertible, specs: interop.PointerConvertible, names: interop.PointerConvertible): number;

declare function PBCatalogSearchSync(paramBlock: interop.PointerConvertible): number;

declare function PBCatalogSearchAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCreateFileAndOpenForkUnicode(parentRef: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible, permissions: number, forkRefNum: interop.PointerConvertible, newRef: interop.PointerConvertible): number;

declare function PBCreateFileAndOpenForkUnicodeSync(paramBlock: interop.PointerConvertible): number;

declare function PBCreateFileAndOpenForkUnicodeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCreateFork(ref: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible): number;

declare function PBCreateForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBCreateForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSDeleteFork(ref: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible): number;

declare function PBDeleteForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBDeleteForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSIterateForks(ref: interop.PointerConvertible, forkIterator: interop.PointerConvertible, forkName: interop.PointerConvertible, forkSize: interop.PointerConvertible, forkPhysicalSize: interop.PointerConvertible): number;

declare function PBIterateForksSync(paramBlock: interop.PointerConvertible): number;

declare function PBIterateForksAsync(paramBlock: interop.PointerConvertible): void;

declare function FSOpenFork(ref: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible, permissions: number, forkRefNum: interop.PointerConvertible): number;

declare function PBOpenForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBOpenForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSReadFork(forkRefNum: number, positionMode: number, positionOffset: number, requestCount: number, buffer: interop.PointerConvertible, actualCount: interop.PointerConvertible): number;

declare function PBReadForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBReadForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSWriteFork(forkRefNum: number, positionMode: number, positionOffset: number, requestCount: number, buffer: interop.PointerConvertible, actualCount: interop.PointerConvertible): number;

declare function PBWriteForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBWriteForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSGetForkPosition(forkRefNum: number, position: interop.PointerConvertible): number;

declare function PBGetForkPositionSync(paramBlock: interop.PointerConvertible): number;

declare function PBGetForkPositionAsync(paramBlock: interop.PointerConvertible): void;

declare function FSSetForkPosition(forkRefNum: number, positionMode: number, positionOffset: number): number;

declare function PBSetForkPositionSync(paramBlock: interop.PointerConvertible): number;

declare function PBSetForkPositionAsync(paramBlock: interop.PointerConvertible): void;

declare function FSGetForkSize(forkRefNum: number, forkSize: interop.PointerConvertible): number;

declare function PBGetForkSizeSync(paramBlock: interop.PointerConvertible): number;

declare function PBGetForkSizeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSSetForkSize(forkRefNum: number, positionMode: number, positionOffset: number): number;

declare function PBSetForkSizeSync(paramBlock: interop.PointerConvertible): number;

declare function PBSetForkSizeAsync(paramBlock: interop.PointerConvertible): void;

declare function FSAllocateFork(forkRefNum: number, flags: number, positionMode: number, positionOffset: number, requestCount: number, actualCount: interop.PointerConvertible): number;

declare function PBAllocateForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBAllocateForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSFlushFork(forkRefNum: number): number;

declare function PBFlushForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBFlushForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSCloseFork(forkRefNum: number): number;

declare function PBCloseForkSync(paramBlock: interop.PointerConvertible): number;

declare function PBCloseForkAsync(paramBlock: interop.PointerConvertible): void;

declare function FSGetForkCBInfo(desiredRefNum: number, volume: number, iterator: interop.PointerConvertible, actualRefNum: interop.PointerConvertible, forkInfo: interop.PointerConvertible, ref: interop.PointerConvertible, outForkName: interop.PointerConvertible): number;

declare function PBGetForkCBInfoSync(paramBlock: interop.PointerConvertible): number;

declare function PBGetForkCBInfoAsync(paramBlock: interop.PointerConvertible): void;

declare function FSLockRange(forkRefNum: number, positionMode: number, positionOffset: number, requestCount: number, rangeStart: interop.PointerConvertible): number;

declare function PBXLockRangeSync(paramBlock: interop.PointerConvertible): number;

declare function PBXLockRangeAsync(paramBlock: interop.PointerConvertible): number;

declare function FSUnlockRange(forkRefNum: number, positionMode: number, positionOffset: number, requestCount: number, rangeStart: interop.PointerConvertible): number;

declare function PBXUnlockRangeSync(paramBlock: interop.PointerConvertible): number;

declare function PBXUnlockRangeAsync(paramBlock: interop.PointerConvertible): number;

declare function FSGetVolumeInfo(volume: number, volumeIndex: number, actualVolume: interop.PointerConvertible, whichInfo: number, info: interop.PointerConvertible, volumeName: interop.PointerConvertible, rootDirectory: interop.PointerConvertible): number;

declare function PBGetVolumeInfoSync(paramBlock: interop.PointerConvertible): number;

declare function PBGetVolumeInfoAsync(paramBlock: interop.PointerConvertible): void;

declare function FSSetVolumeInfo(volume: number, whichInfo: number, info: interop.PointerConvertible): number;

declare function PBSetVolumeInfoSync(paramBlock: interop.PointerConvertible): number;

declare function PBSetVolumeInfoAsync(paramBlock: interop.PointerConvertible): void;

declare function FSGetDataForkName(dataForkName: interop.PointerConvertible): number;

declare function FSGetResourceForkName(resourceForkName: interop.PointerConvertible): number;

declare function FSRefMakePath(ref: interop.PointerConvertible, path: interop.PointerConvertible, pathBufferSize: number): number;

declare function FSPathMakeRef(path: interop.PointerConvertible, ref: interop.PointerConvertible, isDirectory: interop.PointerConvertible): number;

declare function FSPathMakeRefWithOptions(path: interop.PointerConvertible, options: number, ref: interop.PointerConvertible, isDirectory: interop.PointerConvertible): number;

declare function FSIsFSRefValid(ref: interop.PointerConvertible): number;

declare function FNNotify(ref: interop.PointerConvertible, message: number, flags: number): number;

declare function FNNotifyByPath(path: interop.PointerConvertible, message: number, flags: number): number;

declare function FNNotifyAll(message: number, flags: number): number;

declare function NewFNSubscriptionUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void): (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void;

declare function DisposeFNSubscriptionUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void): void;

declare function InvokeFNSubscriptionUPP(message: number, flags: number, refcon: interop.PointerConvertible, subscription: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void): void;

declare function FNSubscribe(directoryRef: interop.PointerConvertible, callback: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void, refcon: interop.PointerConvertible, flags: number, subscription: interop.PointerConvertible): number;

declare function FNSubscribeByPath(directoryPath: interop.PointerConvertible, callback: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void, refcon: interop.PointerConvertible, flags: number, subscription: interop.PointerConvertible): number;

declare function FNUnsubscribe(subscription: interop.PointerConvertible): number;

declare function FNGetDirectoryForSubscription(subscription: interop.PointerConvertible, ref: interop.PointerConvertible): number;

declare function NewFSVolumeMountUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void;

declare function NewFSVolumeUnmountUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void;

declare function NewFSVolumeEjectUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void;

declare function DisposeFSVolumeMountUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void): void;

declare function DisposeFSVolumeUnmountUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): void;

declare function DisposeFSVolumeEjectUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): void;

declare function InvokeFSVolumeMountUPP(volumeOp: interop.PointerConvertible, clientData: interop.PointerConvertible, err: number, mountedVolumeRefNum: number, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void): void;

declare function InvokeFSVolumeUnmountUPP(volumeOp: interop.PointerConvertible, clientData: interop.PointerConvertible, err: number, volumeRefNum: number, dissenter: number, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): void;

declare function InvokeFSVolumeEjectUPP(volumeOp: interop.PointerConvertible, clientData: interop.PointerConvertible, err: number, volumeRefNum: number, dissenter: number, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): void;

declare function FSCreateVolumeOperation(volumeOp: interop.PointerConvertible): number;
...
declare function FSCancelVolumeOperation(volumeOp: interop.PointerConvertible): number;
...
declare function FSCopyDiskIDForVolume(vRefNum: number, diskID: interop.PointerConvertible): number;
...
declare function FSGetVolumeMountInfoSize(volume: number, size: interop.PointerConvertible): number;

declare function FSGetVolumeMountInfo(volume: number, buffer: interop.PointerConvertible, bufferSize: number, actualSize: interop.PointerConvertible): number;

declare function FSVolumeMount(buffer: interop.PointerConvertible, mountedVolume: interop.PointerConvertible): number;

declare function FSFlushVolume(vRefNum: number): number;

declare function PBFlushVolumeSync(paramBlock: interop.PointerConvertible): number;

declare function PBFlushVolumeAsync(paramBlock: interop.PointerConvertible): number;

declare function PBFSCopyFileSync(paramBlock: interop.PointerConvertible): number;

declare function PBFSCopyFileAsync(paramBlock: interop.PointerConvertible): number;

declare function FSResolveNodeID(volume: number, nodeID: number, newRef: interop.PointerConvertible): number;

declare function PBFSResolveNodeIDSync(paramBlock: interop.PointerConvertible): number;

declare function PBFSResolveNodeIDAsync(paramBlock: interop.PointerConvertible): number;

declare function NewResErrUPP(userRoutine: (p1: number) => void): (p1: number) => void;

declare function DisposeResErrUPP(userUPP: (p1: number) => void): void;

declare function InvokeResErrUPP(thErr: number, userUPP: (p1: number) => void): void;

declare function CloseResFile(refNum: number): void;

declare function ResError(): number;

declare function CurResFile(): number;

declare function HomeResFile(theResource: interop.PointerConvertible): number;

declare function UseResFile(refNum: number): void;

declare function CountTypes(): number;

declare function Count1Types(): number;

declare function GetIndType(theType: interop.PointerConvertible, itemIndex: number): void;

declare function Get1IndType(theType: interop.PointerConvertible, itemIndex: number): void;

declare function SetResLoad(load: number): void;

declare function CountResources(theType: number): number;

declare function Count1Resources(theType: number): number;

declare function GetIndResource(theType: number, itemIndex: number): interop.Pointer;

declare function Get1IndResource(theType: number, itemIndex: number): interop.Pointer;

declare function GetResource(theType: number, theID: number): interop.Pointer;

declare function Get1Resource(theType: number, theID: number): interop.Pointer;

declare function GetNamedResource(theType: number, name: interop.PointerConvertible): interop.Pointer;

declare function Get1NamedResource(theType: number, name: interop.PointerConvertible): interop.Pointer;

declare function LoadResource(theResource: interop.PointerConvertible): void;

declare function ReleaseResource(theResource: interop.PointerConvertible): void;

declare function DetachResource(theResource: interop.PointerConvertible): void;

declare function UniqueID(theType: number): number;

declare function Unique1ID(theType: number): number;

declare function GetResAttrs(theResource: interop.PointerConvertible): number;

declare function GetResInfo(theResource: interop.PointerConvertible, theID: interop.PointerConvertible, theType: interop.PointerConvertible, name: unknown /* const array */): void;

declare function SetResInfo(theResource: interop.PointerConvertible, theID: number, name: interop.PointerConvertible): void;

declare function AddResource(theData: interop.PointerConvertible, theType: number, theID: number, name: interop.PointerConvertible): void;

declare function GetResourceSizeOnDisk(theResource: interop.PointerConvertible): number;

declare function GetMaxResourceSize(theResource: interop.PointerConvertible): number;

declare function SetResAttrs(theResource: interop.PointerConvertible, attrs: number): void;

declare function ChangedResource(theResource: interop.PointerConvertible): void;

declare function RemoveResource(theResource: interop.PointerConvertible): void;

declare function UpdateResFile(refNum: number): void;

declare function WriteResource(theResource: interop.PointerConvertible): void;

declare function SetResPurge(install: number): void;

declare function GetResFileAttrs(refNum: number): number;

declare function SetResFileAttrs(refNum: number, attrs: number): void;

declare function ReadPartialResource(theResource: interop.PointerConvertible, offset: number, buffer: interop.PointerConvertible, count: number): void;

declare function WritePartialResource(theResource: interop.PointerConvertible, offset: number, buffer: interop.PointerConvertible, count: number): void;

declare function SetResourceSize(theResource: interop.PointerConvertible, newSize: number): void;

declare function GetNextFOND(fondHandle: interop.PointerConvertible): interop.Pointer;

declare function InsertResourceFile(refNum: number, where: number): number;

declare function DetachResourceFile(refNum: number): number;

declare function GetTopResourceFile(refNum: interop.PointerConvertible): number;

declare function GetNextResourceFile(curRefNum: number, nextRefNum: interop.PointerConvertible): number;

declare function FSOpenResFile(ref: interop.PointerConvertible, permission: number): number;

declare function FSCreateResFile(parentRef: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible, newRef: interop.PointerConvertible, newSpec: interop.PointerConvertible): void;

declare function FSResourceFileAlreadyOpen(resourceFileRef: interop.PointerConvertible, inChain: interop.PointerConvertible, refNum: interop.PointerConvertible): number;

declare function FSOpenOrphanResFile(ref: interop.PointerConvertible, permission: number, refNum: interop.PointerConvertible): number;

declare function FSCreateResourceFile(parentRef: interop.PointerConvertible, nameLength: number, name: interop.PointerConvertible, whichInfo: number, catalogInfo: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible, newRef: interop.PointerConvertible, newSpec: interop.PointerConvertible): number;

declare function FSCreateResourceFork(ref: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible, flags: number): number;

declare function FSOpenResourceFile(ref: interop.PointerConvertible, forkNameLength: number, forkName: interop.PointerConvertible, permissions: number, refNum: interop.PointerConvertible): number;

declare function CSSetComponentsThreadMode(mode: number): void;

declare function CSGetComponentsThreadMode(): number;

declare function NewComponentFunctionUPP(userRoutine: () => number, procInfo: number): () => number;

declare function DisposeComponentFunctionUPP(userUPP: () => number): void;

declare function RegisterComponent(cd: interop.PointerConvertible, componentEntryPoint: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number, global: number, componentName: interop.PointerConvertible, componentInfo: interop.PointerConvertible, componentIcon: interop.PointerConvertible): interop.Pointer;

declare function RegisterComponentResource(cr: interop.PointerConvertible, global: number): interop.Pointer;

declare function UnregisterComponent(aComponent: interop.PointerConvertible): number;

declare function FindNextComponent(aComponent: interop.PointerConvertible, looking: interop.PointerConvertible): interop.Pointer;

declare function CountComponents(looking: interop.PointerConvertible): number;

declare function GetComponentInfo(aComponent: interop.PointerConvertible, cd: interop.PointerConvertible, componentName: interop.PointerConvertible, componentInfo: interop.PointerConvertible, componentIcon: interop.PointerConvertible): number;

declare function GetComponentListModSeed(): number;

declare function GetComponentTypeModSeed(componentType: number): number;

declare function OpenAComponent(aComponent: interop.PointerConvertible, ci: interop.PointerConvertible): number;

declare function OpenComponent(aComponent: interop.PointerConvertible): interop.Pointer;

declare function CloseComponent(aComponentInstance: interop.PointerConvertible): number;

declare function GetComponentInstanceError(aComponentInstance: interop.PointerConvertible): number;

declare function ResolveComponentAlias(aComponent: interop.PointerConvertible): interop.Pointer;

declare function GetComponentPublicResource(aComponent: interop.PointerConvertible, resourceType: number, resourceID: number, theResource: interop.PointerConvertible): number;

declare function GetComponentPublicResourceList(resourceType: number, resourceID: number, flags: number, cd: interop.PointerConvertible, missingProc: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number, refCon: interop.PointerConvertible, atomContainerPtr: interop.PointerConvertible): number;

declare function GetComponentPublicIndString(aComponent: interop.PointerConvertible, theString: unknown /* const array */, strListID: number, index: number): number;

declare function SetComponentInstanceError(aComponentInstance: interop.PointerConvertible, theError: number): void;

declare function GetComponentRefcon(aComponent: interop.PointerConvertible): number;

declare function SetComponentRefcon(aComponent: interop.PointerConvertible, theRefcon: number): void;

declare function OpenComponentResFile(aComponent: interop.PointerConvertible): number;

declare function OpenAComponentResFile(aComponent: interop.PointerConvertible, resRef: interop.PointerConvertible): number;

declare function CloseComponentResFile(refnum: number): number;

declare function GetComponentResource(aComponent: interop.PointerConvertible, resType: number, resID: number, theResource: interop.PointerConvertible): number;

declare function GetComponentIndString(aComponent: interop.PointerConvertible, theString: unknown /* const array */, strListID: number, index: number): number;

declare function GetComponentInstanceStorage(aComponentInstance: interop.PointerConvertible): interop.Pointer;

declare function SetComponentInstanceStorage(aComponentInstance: interop.PointerConvertible, theStorage: interop.PointerConvertible): void;

declare function CountComponentInstances(aComponent: interop.PointerConvertible): number;

declare function CallComponentFunction(params: interop.PointerConvertible, func: () => number): number;

declare function CallComponentFunctionWithStorage(storage: interop.PointerConvertible, params: interop.PointerConvertible, func: () => number): number;

declare function CallComponentFunctionWithStorageProcInfo(storage: interop.PointerConvertible, params: interop.PointerConvertible, func: () => number, funcProcInfo: number): number;

declare function DelegateComponentCall(originalParams: interop.PointerConvertible, ci: interop.PointerConvertible): number;

declare function SetDefaultComponent(aComponent: interop.PointerConvertible, flags: number): number;

declare function OpenDefaultComponent(componentType: number, componentSubType: number): interop.Pointer;

declare function OpenADefaultComponent(componentType: number, componentSubType: number, ci: interop.PointerConvertible): number;

declare function CaptureComponent(capturedComponent: interop.PointerConvertible, capturingComponent: interop.PointerConvertible): interop.Pointer;

declare function UncaptureComponent(aComponent: interop.PointerConvertible): number;

declare function RegisterComponentResourceFile(resRefNum: number, global: number): number;

declare function RegisterComponentFileRef(ref: interop.PointerConvertible, global: number): number;

declare function RegisterComponentFileRefEntries(ref: interop.PointerConvertible, global: number, toRegister: interop.PointerConvertible, registerCount: number): number;

declare function CallComponentOpen(ci: interop.PointerConvertible, self: interop.PointerConvertible): number;

declare function CallComponentClose(ci: interop.PointerConvertible, self: interop.PointerConvertible): number;

declare function CallComponentCanDo(ci: interop.PointerConvertible, ftnNumber: number): number;

declare function CallComponentVersion(ci: interop.PointerConvertible): number;

declare function CallComponentRegister(ci: interop.PointerConvertible): number;

declare function CallComponentTarget(ci: interop.PointerConvertible, target: interop.PointerConvertible): number;

declare function CallComponentUnregister(ci: interop.PointerConvertible): number;

declare function CallComponentGetMPWorkFunction(ci: interop.PointerConvertible, workFunction: interop.PointerConvertible, refCon: interop.PointerConvertible): number;

declare function CallComponentGetPublicResource(ci: interop.PointerConvertible, resourceType: number, resourceID: number, resource: interop.PointerConvertible): number;

declare function CallComponentDispatch(cp: interop.PointerConvertible): number;

declare function NewComponentMPWorkFunctionUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number;

declare function NewComponentRoutineUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number;

declare function NewGetMissingComponentResourceUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function DisposeComponentMPWorkFunctionUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): void;

declare function DisposeComponentRoutineUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): void;

declare function DisposeGetMissingComponentResourceUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function InvokeComponentMPWorkFunctionUPP(globalRefCon: interop.PointerConvertible, header: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): number;

declare function InvokeComponentRoutineUPP(cp: interop.PointerConvertible, componentStorage: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): number;

declare function InvokeGetMissingComponentResourceUPP(c: interop.PointerConvertible, resType: number, resID: number, refCon: interop.PointerConvertible, resource: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): number;

declare function MPProcessors(): number;

declare function MPProcessorsScheduled(): number;

declare function MPCreateTask(entryPoint: (p1: interop.PointerConvertible) => number, parameter: interop.PointerConvertible, stackSize: number, notifyQueue: interop.PointerConvertible, terminationParameter1: interop.PointerConvertible, terminationParameter2: interop.PointerConvertible, options: number, task: interop.PointerConvertible): number;

declare function MPTerminateTask(task: interop.PointerConvertible, terminationStatus: number): number;

declare function MPSetTaskWeight(task: interop.PointerConvertible, weight: number): number;

declare function MPTaskIsPreemptive(taskID: interop.PointerConvertible): number;

declare function MPExit(status: number): void;

declare function MPYield(): void;

declare function MPCurrentTaskID(): interop.Pointer;

declare function MPSetTaskType(task: interop.PointerConvertible, taskType: number): number;

declare function MPAllocateTaskStorageIndex(taskIndex: interop.PointerConvertible): number;

declare function MPDeallocateTaskStorageIndex(taskIndex: number): number;

declare function MPSetTaskStorageValue(taskIndex: number, value: interop.PointerConvertible): number;

declare function MPGetTaskStorageValue(taskIndex: number): interop.Pointer;

declare function MPCreateQueue(queue: interop.PointerConvertible): number;

declare function MPDeleteQueue(queue: interop.PointerConvertible): number;

declare function MPNotifyQueue(queue: interop.PointerConvertible, param1: interop.PointerConvertible, param2: interop.PointerConvertible, param3: interop.PointerConvertible): number;

declare function MPWaitOnQueue(queue: interop.PointerConvertible, param1: interop.PointerConvertible, param2: interop.PointerConvertible, param3: interop.PointerConvertible, timeout: number): number;

declare function MPSetQueueReserve(queue: interop.PointerConvertible, count: number): number;

declare function MPCreateSemaphore(maximumValue: number, initialValue: number, semaphore: interop.PointerConvertible): number;

declare function MPDeleteSemaphore(semaphore: interop.PointerConvertible): number;

declare function MPSignalSemaphore(semaphore: interop.PointerConvertible): number;

declare function MPWaitOnSemaphore(semaphore: interop.PointerConvertible, timeout: number): number;

declare function MPCreateCriticalRegion(criticalRegion: interop.PointerConvertible): number;

declare function MPDeleteCriticalRegion(criticalRegion: interop.PointerConvertible): number;

declare function MPEnterCriticalRegion(criticalRegion: interop.PointerConvertible, timeout: number): number;

declare function MPExitCriticalRegion(criticalRegion: interop.PointerConvertible): number;

declare function MPCreateEvent(event: interop.PointerConvertible): number;

declare function MPDeleteEvent(event: interop.PointerConvertible): number;

declare function MPSetEvent(event: interop.PointerConvertible, flags: number): number;

declare function MPWaitForEvent(event: interop.PointerConvertible, flags: interop.PointerConvertible, timeout: number): number;

declare function MPCreateNotification(notificationID: interop.PointerConvertible): number;

declare function MPDeleteNotification(notificationID: interop.PointerConvertible): number;

declare function MPModifyNotification(notificationID: interop.PointerConvertible, anID: interop.PointerConvertible, notifyParam1: interop.PointerConvertible, notifyParam2: interop.PointerConvertible, notifyParam3: interop.PointerConvertible): number;

declare function MPModifyNotificationParameters(notificationID: interop.PointerConvertible, kind: number, notifyParam1: interop.PointerConvertible, notifyParam2: interop.PointerConvertible, notifyParam3: interop.PointerConvertible): number;

declare function MPCauseNotification(notificationID: interop.PointerConvertible): number;

declare function MPDelayUntil(expirationTime: interop.PointerConvertible): number;

declare function MPCreateTimer(timerID: interop.PointerConvertible): number;

declare function MPDeleteTimer(timerID: interop.PointerConvertible): number;

declare function MPSetTimerNotify(timerID: interop.PointerConvertible, anID: interop.PointerConvertible, notifyParam1: interop.PointerConvertible, notifyParam2: interop.PointerConvertible, notifyParam3: interop.PointerConvertible): number;

declare function MPArmTimer(timerID: interop.PointerConvertible, expirationTime: interop.PointerConvertible, options: number): number;

declare function MPCancelTimer(timerID: interop.PointerConvertible, timeRemaining: interop.PointerConvertible): number;

declare function MPAllocateAligned(size: number, alignment: number, options: number): interop.Pointer;

declare function MPAllocate(size: number): interop.Pointer;

declare function MPFree(object: interop.PointerConvertible): void;

declare function MPGetAllocatedBlockSize(object: interop.PointerConvertible): number;

declare function MPBlockCopy(source: interop.PointerConvertible, destination: interop.PointerConvertible, size: number): void;

declare function MPBlockClear(address: interop.PointerConvertible, size: number): void;

declare function MPSetExceptionHandler(task: interop.PointerConvertible, exceptionQ: interop.PointerConvertible): number;

declare function MPDisposeTaskException(task: interop.PointerConvertible, action: number): number;

declare function MPExtractTaskState(task: interop.PointerConvertible, kind: number, info: interop.PointerConvertible): number;

declare function MPSetTaskState(task: interop.PointerConvertible, kind: number, info: interop.PointerConvertible): number;

declare function MPThrowException(task: interop.PointerConvertible, kind: number): number;

declare function MPRegisterDebugger(queue: interop.PointerConvertible, level: number): number;

declare function MPUnregisterDebugger(queue: interop.PointerConvertible): number;

declare function MPRemoteCall(remoteProc: (p1: interop.PointerConvertible) => interop.Pointer, parameter: interop.PointerConvertible, context: number): interop.Pointer;

declare function MPRemoteCallCFM(remoteProc: (p1: interop.PointerConvertible) => interop.Pointer, parameter: interop.PointerConvertible, context: number): interop.Pointer;

declare function _MPIsFullyInitialized(): number;

declare function _MPLibraryVersion(versionCString: interop.PointerConvertible, major: interop.PointerConvertible, minor: interop.PointerConvertible, release: interop.PointerConvertible, revision: interop.PointerConvertible): void;

declare function _MPLibraryIsCompatible(versionCString: string, major: number, minor: number, release: number, revision: number): number;

declare function FSNewAlias(fromFile: interop.PointerConvertible, target: interop.PointerConvertible, inAlias: interop.PointerConvertible): number;

declare function FSNewAliasMinimal(target: interop.PointerConvertible, inAlias: interop.PointerConvertible): number;

declare function FSIsAliasFile(fileRef: interop.PointerConvertible, aliasFileFlag: interop.PointerConvertible, folderFlag: interop.PointerConvertible): number;

declare function FSResolveAliasWithMountFlags(fromFile: interop.PointerConvertible, inAlias: interop.PointerConvertible, target: interop.PointerConvertible, wasChanged: interop.PointerConvertible, mountFlags: number): number;

declare function FSResolveAlias(fromFile: interop.PointerConvertible, alias: interop.PointerConvertible, target: interop.PointerConvertible, wasChanged: interop.PointerConvertible): number;

declare function FSResolveAliasFileWithMountFlags(theRef: interop.PointerConvertible, resolveAliasChains: number, targetIsFolder: interop.PointerConvertible, wasAliased: interop.PointerConvertible, mountFlags: number): number;

declare function FSResolveAliasFile(theRef: interop.PointerConvertible, resolveAliasChains: number, targetIsFolder: interop.PointerConvertible, wasAliased: interop.PointerConvertible): number;

declare function FSFollowFinderAlias(fromFile: interop.PointerConvertible, alias: interop.PointerConvertible, logon: number, target: interop.PointerConvertible, wasChanged: interop.PointerConvertible): number;

declare function FSUpdateAlias(fromFile: interop.PointerConvertible, target: interop.PointerConvertible, alias: interop.PointerConvertible, wasChanged: interop.PointerConvertible): number;

declare function FSNewAliasUnicode(fromFile: interop.PointerConvertible, targetParentRef: interop.PointerConvertible, targetNameLength: number, targetName: interop.PointerConvertible, inAlias: interop.PointerConvertible, isDirectory: interop.PointerConvertible): number;

declare function FSNewAliasMinimalUnicode(targetParentRef: interop.PointerConvertible, targetNameLength: number, targetName: interop.PointerConvertible, inAlias: interop.PointerConvertible, isDirectory: interop.PointerConvertible): number;

declare function FSNewAliasFromPath(fromFilePath: string, targetPath: string, flags: number, inAlias: interop.PointerConvertible, isDirectory: interop.PointerConvertible): number;

declare function FSMatchAliasBulk(fromFile: interop.PointerConvertible, rulesMask: number, inAlias: interop.PointerConvertible, aliasCount: interop.PointerConvertible, aliasList: interop.PointerConvertible, needsUpdate: interop.PointerConvertible, aliasFilter: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: string) => number, yourDataPtr: interop.PointerConvertible): number;

declare function FSCopyAliasInfo(inAlias: interop.PointerConvertible, targetName: interop.PointerConvertible, volumeName: interop.PointerConvertible, pathString: interop.PointerConvertible, whichInfo: interop.PointerConvertible, info: interop.PointerConvertible): number;

declare function GetAliasSize(alias: interop.PointerConvertible): number;

declare function GetAliasUserType(alias: interop.PointerConvertible): number;

declare function SetAliasUserType(alias: interop.PointerConvertible, userType: number): void;

declare function GetAliasSizeFromPtr(alias: interop.PointerConvertible): number;

declare function GetAliasUserTypeFromPtr(alias: interop.PointerConvertible): number;

declare function SetAliasUserTypeWithPtr(alias: interop.PointerConvertible, userType: number): void;

declare function LocaleRefFromLangOrRegionCode(lang: number, region: number, locale: interop.PointerConvertible): number;

declare function LocaleRefFromLocaleString(localeString: interop.Pointer, locale: interop.PointerConvertible): number;

declare function LocaleRefGetPartString(locale: interop.PointerConvertible, partMask: number, maxStringLen: number, partString: interop.Pointer): number;

declare function LocaleStringToLangAndRegionCodes(localeString: interop.Pointer, lang: interop.PointerConvertible, region: interop.PointerConvertible): number;

declare function LocaleOperationCountLocales(opClass: number, localeCount: interop.PointerConvertible): number;

declare function LocaleOperationGetLocales(opClass: number, maxLocaleCount: number, actualLocaleCount: interop.PointerConvertible, localeVariantList: interop.Pointer): number;

declare function LocaleGetName(locale: interop.PointerConvertible, opVariant: number, nameMask: number, displayLocale: interop.PointerConvertible, maxNameLen: number, actualNameLen: interop.PointerConvertible, displayName: interop.Pointer): number;

declare function LocaleCountNames(locale: interop.PointerConvertible, opVariant: number, nameMask: number, nameCount: interop.PointerConvertible): number;

declare function LocaleGetIndName(locale: interop.PointerConvertible, opVariant: number, nameMask: number, nameIndex: number, maxNameLen: number, actualNameLen: interop.PointerConvertible, displayName: interop.Pointer, displayLocale: interop.PointerConvertible): number;

declare function LocaleOperationGetName(opClass: number, displayLocale: interop.PointerConvertible, maxNameLen: number, actualNameLen: interop.PointerConvertible, displayName: interop.Pointer): number;

declare function LocaleOperationCountNames(opClass: number, nameCount: interop.PointerConvertible): number;

declare function LocaleOperationGetIndName(opClass: number, nameIndex: number, maxNameLen: number, actualNameLen: interop.PointerConvertible, displayName: interop.Pointer, displayLocale: interop.PointerConvertible): number;

declare function DebugAssert(componentSignature: number, options: number, assertionString: string, exceptionLabelString: string, errorString: string, fileName: string, lineNumber: number, value: interop.PointerConvertible): void;

declare function TaskLevel(): number;

declare function NewDebugComponent(componentSignature: number, componentName: interop.PointerConvertible, componentCallback: (p1: number, p2: number, p3: interop.PointerConvertible) => void): number;

declare function NewDebugOption(componentSignature: number, optionSelectorNum: number, optionName: interop.PointerConvertible): number;

declare function DisposeDebugComponent(componentSignature: number): number;

declare function GetDebugComponentInfo(itemIndex: number, componentSignature: interop.PointerConvertible, componentName: unknown /* const array */): number;

declare function GetDebugOptionInfo(itemIndex: number, componentSignature: number, optionSelectorNum: interop.PointerConvertible, optionName: unknown /* const array */, optionSetting: interop.PointerConvertible): number;

declare function SetDebugOptionValue(componentSignature: number, optionSelectorNum: number, newOptionSetting: number): number;

declare function InstallDebugAssertOutputHandler(handler: (p1: number, p2: number, p3: string, p4: string, p5: string, p6: string, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => void): void;

declare function GetMacOSStatusErrorString(err: number): string;

declare function GetMacOSStatusCommentString(err: number): string;

declare function NewDebugComponentCallbackUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible) => void): (p1: number, p2: number, p3: interop.PointerConvertible) => void;

declare function NewDebugAssertOutputHandlerUPP(userRoutine: (p1: number, p2: number, p3: string, p4: string, p5: string, p6: string, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => void): (p1: number, p2: number, p3: string, p4: string, p5: string, p6: string, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => void;

declare function DisposeDebugComponentCallbackUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible) => void): void;

declare function DisposeDebugAssertOutputHandlerUPP(userUPP: (p1: number, p2: number, p3: string, p4: string, p5: string, p6: string, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => void): void;

declare function InvokeDebugComponentCallbackUPP(optionSelectorNum: number, command: number, optionSetting: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible) => void): void;

declare function InvokeDebugAssertOutputHandlerUPP(componentSignature: number, options: number, assertionString: string, exceptionLabelString: string, errorString: string, fileName: string, lineNumber: number, value: interop.PointerConvertible, outputMsg: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: string, p4: string, p5: string, p6: string, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => void): void;

declare function PLstrcmp(str1: interop.PointerConvertible, str2: interop.PointerConvertible): number;

declare function PLstrncmp(str1: interop.PointerConvertible, str2: interop.PointerConvertible, num: number): number;

declare function PLstrcpy(dest: interop.PointerConvertible, source: interop.PointerConvertible): interop.Pointer;

declare function PLstrncpy(dest: interop.PointerConvertible, source: interop.PointerConvertible, num: number): interop.Pointer;

declare function PLstrcat(str: interop.PointerConvertible, append: interop.PointerConvertible): interop.Pointer;

declare function PLstrncat(str1: interop.PointerConvertible, append: interop.PointerConvertible, num: number): interop.Pointer;

declare function PLstrchr(str1: interop.PointerConvertible, ch1: number): string;

declare function PLstrrchr(str1: interop.PointerConvertible, ch1: number): string;

declare function PLstrpbrk(str1: interop.PointerConvertible, charSet: interop.PointerConvertible): string;

declare function PLstrspn(str1: interop.PointerConvertible, charSet: interop.PointerConvertible): number;

declare function PLstrstr(str1: interop.PointerConvertible, searchStr: interop.PointerConvertible): string;

declare function PLstrlen(str: interop.PointerConvertible): number;

declare function PLpos(str1: interop.PointerConvertible, searchStr: interop.PointerConvertible): number;

declare function CompareAndSwap(oldValue: number, newValue: number, address: interop.PointerConvertible): number;

declare function TestAndClear(bit: number, address: interop.PointerConvertible): number;

declare function TestAndSet(bit: number, address: interop.PointerConvertible): number;

declare function IncrementAtomic8(address: interop.PointerConvertible): number;

declare function DecrementAtomic8(address: interop.PointerConvertible): number;

declare function AddAtomic8(amount: number, address: interop.PointerConvertible): number;

declare function BitAndAtomic8(mask: number, address: interop.PointerConvertible): number;

declare function BitOrAtomic8(mask: number, address: interop.PointerConvertible): number;

declare function BitXorAtomic8(mask: number, address: interop.PointerConvertible): number;

declare function IncrementAtomic16(address: interop.PointerConvertible): number;

declare function DecrementAtomic16(address: interop.PointerConvertible): number;

declare function AddAtomic16(amount: number, address: interop.PointerConvertible): number;

declare function BitAndAtomic16(mask: number, address: interop.PointerConvertible): number;

declare function BitOrAtomic16(mask: number, address: interop.PointerConvertible): number;

declare function BitXorAtomic16(mask: number, address: interop.PointerConvertible): number;

declare function IncrementAtomic(address: interop.PointerConvertible): number;

declare function DecrementAtomic(address: interop.PointerConvertible): number;

declare function AddAtomic(amount: number, address: interop.PointerConvertible): number;

declare function BitAndAtomic(mask: number, address: interop.PointerConvertible): number;

declare function BitOrAtomic(mask: number, address: interop.PointerConvertible): number;

declare function BitXorAtomic(mask: number, address: interop.PointerConvertible): number;

declare function NewExceptionHandlerUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function DisposeExceptionHandlerUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function InvokeExceptionHandlerUPP(theException: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function InstallExceptionHandler(theHandler: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function UpTime(): UnsignedWide;

declare function AbsoluteToNanoseconds(absoluteTime: UnsignedWide): UnsignedWide;

declare function AbsoluteToDuration(absoluteTime: UnsignedWide): number;

declare function NanosecondsToAbsolute(nanoseconds: UnsignedWide): UnsignedWide;

declare function DurationToAbsolute(duration: number): UnsignedWide;

declare function AddAbsoluteToAbsolute(absoluteTime1: UnsignedWide, absoluteTime2: UnsignedWide): UnsignedWide;

declare function SubAbsoluteFromAbsolute(leftAbsoluteTime: UnsignedWide, rightAbsoluteTime: UnsignedWide): UnsignedWide;

declare function AddNanosecondsToAbsolute(nanoseconds: UnsignedWide, absoluteTime: UnsignedWide): UnsignedWide;

declare function AddDurationToAbsolute(duration: number, absoluteTime: UnsignedWide): UnsignedWide;

declare function SubNanosecondsFromAbsolute(nanoseconds: UnsignedWide, absoluteTime: UnsignedWide): UnsignedWide;

declare function SubDurationFromAbsolute(duration: number, absoluteTime: UnsignedWide): UnsignedWide;

declare function AbsoluteDeltaToNanoseconds(leftAbsoluteTime: UnsignedWide, rightAbsoluteTime: UnsignedWide): UnsignedWide;

declare function AbsoluteDeltaToDuration(leftAbsoluteTime: UnsignedWide, rightAbsoluteTime: UnsignedWide): number;

declare function DurationToNanoseconds(theDuration: number): UnsignedWide;

declare function NanosecondsToDuration(theNanoseconds: UnsignedWide): number;

declare function numtostring(theNum: number, theString: string): void;

declare function Munger(h: interop.PointerConvertible, offset: number, ptr1: interop.PointerConvertible, len1: number, ptr2: interop.PointerConvertible, len2: number): number;

declare function BitTst(bytePtr: interop.PointerConvertible, bitNum: number): number;

declare function BitSet(bytePtr: interop.PointerConvertible, bitNum: number): void;

declare function BitClr(bytePtr: interop.PointerConvertible, bitNum: number): void;

declare function BitAnd(value1: number, value2: number): number;

declare function BitOr(value1: number, value2: number): number;

declare function BitXor(value1: number, value2: number): number;

declare function BitNot(value: number): number;

declare function BitShift(value: number, count: number): number;

declare function NewIndexToUCStringUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function DisposeIndexToUCStringUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function InvokeIndexToUCStringUPP(index: number, listDataPtr: interop.PointerConvertible, refcon: interop.PointerConvertible, outString: interop.PointerConvertible, tsOptions: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): number;

declare function UCKeyTranslate(keyLayoutPtr: interop.PointerConvertible, virtualKeyCode: number, keyAction: number, modifierKeyState: number, keyboardType: number, keyTranslateOptions: number, deadKeyState: interop.PointerConvertible, maxStringLength: number, actualStringLength: interop.PointerConvertible, unicodeString: interop.Pointer): number;

declare function UCCreateCollator(locale: interop.PointerConvertible, opVariant: number, options: number, collatorRef: interop.PointerConvertible): number;

declare function UCGetCollationKey(collatorRef: interop.PointerConvertible, textPtr: interop.PointerConvertible, textLength: number, maxKeySize: number, actualKeySize: interop.PointerConvertible, collationKey: interop.Pointer): number;

declare function UCCompareCollationKeys(key1Ptr: interop.PointerConvertible, key1Length: number, key2Ptr: interop.PointerConvertible, key2Length: number, equivalent: interop.PointerConvertible, order: interop.PointerConvertible): number;

declare function UCCompareText(collatorRef: interop.PointerConvertible, text1Ptr: interop.PointerConvertible, text1Length: number, text2Ptr: interop.PointerConvertible, text2Length: number, equivalent: interop.PointerConvertible, order: interop.PointerConvertible): number;

declare function UCDisposeCollator(collatorRef: interop.PointerConvertible): number;

declare function UCCompareTextDefault(options: number, text1Ptr: interop.PointerConvertible, text1Length: number, text2Ptr: interop.PointerConvertible, text2Length: number, equivalent: interop.PointerConvertible, order: interop.PointerConvertible): number;

declare function UCCompareTextNoLocale(options: number, text1Ptr: interop.PointerConvertible, text1Length: number, text2Ptr: interop.PointerConvertible, text2Length: number, equivalent: interop.PointerConvertible, order: interop.PointerConvertible): number;

declare function UCCreateTextBreakLocator(locale: interop.PointerConvertible, opVariant: number, breakTypes: number, breakRef: interop.PointerConvertible): number;

declare function UCFindTextBreak(breakRef: interop.PointerConvertible, breakType: number, options: number, textPtr: interop.PointerConvertible, textLength: number, startOffset: number, breakOffset: interop.PointerConvertible): number;

declare function UCDisposeTextBreakLocator(breakRef: interop.PointerConvertible): number;

declare function UCTypeSelectCreateSelector(locale: interop.PointerConvertible, opVariant: number, options: number, newSelector: interop.PointerConvertible): number;

declare function UCTypeSelectFlushSelectorData(ref: interop.PointerConvertible): number;
...
declare function annuity(rate: number, periods: number): number;

declare function randomx(x: interop.PointerConvertible): number;

declare function relation(x: number, y: number): number;

declare function num2dec(f: interop.PointerConvertible, x: number, d: interop.PointerConvertible): void;

declare function dec2num(d: interop.PointerConvertible): number;

declare function dec2str(f: interop.PointerConvertible, d: interop.PointerConvertible, s: string): void;

declare function str2dec(s: string, ix: interop.PointerConvertible, d: interop.PointerConvertible, vp: interop.PointerConvertible): void;

declare function dec2f(d: interop.PointerConvertible): number;

declare function dec2s(d: interop.PointerConvertible): number;

declare function dec2l(d: interop.PointerConvertible): number;

declare function relationl(x: number, y: number): number;

declare function num2decl(f: interop.PointerConvertible, x: number, d: interop.PointerConvertible): void;

declare function dec2numl(d: interop.PointerConvertible): number;

declare function x80tod(x80: interop.PointerConvertible): number;

declare function dtox80(x: interop.PointerConvertible, x80: interop.PointerConvertible): void;

declare function x80told(x80: interop.PointerConvertible, x: interop.PointerConvertible): void;

declare function ldtox80(x: interop.PointerConvertible, x80: interop.PointerConvertible): void;

declare function TECCountAvailableTextEncodings(numberEncodings: interop.PointerConvertible): number;

declare function TECGetAvailableTextEncodings(availableEncodings: interop.Pointer, maxAvailableEncodings: number, actualAvailableEncodings: interop.PointerConvertible): number;

declare function TECCountDirectTextEncodingConversions(numberOfEncodings: interop.PointerConvertible): number;

declare function TECGetDirectTextEncodingConversions(availableConversions: interop.Pointer, maxAvailableConversions: number, actualAvailableConversions: interop.PointerConvertible): number;

declare function TECCountDestinationTextEncodings(inputEncoding: number, numberOfEncodings: interop.PointerConvertible): number;

declare function TECGetDestinationTextEncodings(inputEncoding: number, destinationEncodings: interop.Pointer, maxDestinationEncodings: number, actualDestinationEncodings: interop.PointerConvertible): number;

declare function TECGetTextEncodingInternetName(textEncoding: number, encodingName: unknown /* const array */): number;

declare function TECGetTextEncodingFromInternetName(textEncoding: interop.PointerConvertible, encodingName: interop.PointerConvertible): number;

declare function TECCreateConverter(newEncodingConverter: interop.PointerConvertible, inputEncoding: number, outputEncoding: number): number;

declare function TECCreateConverterFromPath(newEncodingConverter: interop.PointerConvertible, inPath: interop.Pointer, inEncodings: number): number;

declare function TECDisposeConverter(newEncodingConverter: interop.PointerConvertible): number;

declare function TECClearConverterContextInfo(encodingConverter: interop.PointerConvertible): number;

declare function TECConvertText(encodingConverter: interop.PointerConvertible, inputBuffer: interop.PointerConvertible, inputBufferLength: number, actualInputLength: interop.PointerConvertible, outputBuffer: interop.PointerConvertible, outputBufferLength: number, actualOutputLength: interop.PointerConvertible): number;

declare function TECFlushText(encodingConverter: interop.PointerConvertible, outputBuffer: interop.PointerConvertible, outputBufferLength: number, actualOutputLength: interop.PointerConvertible): number;

declare function TECCountSubTextEncodings(inputEncoding: number, numberOfEncodings: interop.PointerConvertible): number;

declare function TECGetSubTextEncodings(inputEncoding: number, subEncodings: interop.Pointer, maxSubEncodings: number, actualSubEncodings: interop.PointerConvertible): number;

declare function TECGetEncodingList(encodingConverter: interop.PointerConvertible, numEncodings: interop.PointerConvertible, encodingList: interop.PointerConvertible): number;

declare function TECCreateOneToManyConverter(newEncodingConverter: interop.PointerConvertible, inputEncoding: number, numOutputEncodings: number, outputEncodings: interop.Pointer): number;

declare function TECConvertTextToMultipleEncodings(encodingConverter: interop.PointerConvertible, inputBuffer: interop.PointerConvertible, inputBufferLength: number, actualInputLength: interop.PointerConvertible, outputBuffer: interop.PointerConvertible, outputBufferLength: number, actualOutputLength: interop.PointerConvertible, outEncodingsBuffer: interop.Pointer, maxOutEncodingRuns: number, actualOutEncodingRuns: interop.PointerConvertible): number;

declare function TECFlushMultipleEncodings(encodingConverter: interop.PointerConvertible, outputBuffer: interop.PointerConvertible, outputBufferLength: number, actualOutputLength: interop.PointerConvertible, outEncodingsBuffer: interop.Pointer, maxOutEncodingRuns: number, actualOutEncodingRuns: interop.PointerConvertible): number;

declare function TECCountWebTextEncodings(locale: number, numberEncodings: interop.PointerConvertible): number;

declare function TECGetWebTextEncodings(locale: number, availableEncodings: interop.Pointer, maxAvailableEncodings: number, actualAvailableEncodings: interop.PointerConvertible): number;

declare function TECCountMailTextEncodings(locale: number, numberEncodings: interop.PointerConvertible): number;

declare function TECGetMailTextEncodings(locale: number, availableEncodings: interop.Pointer, maxAvailableEncodings: number, actualAvailableEncodings: interop.PointerConvertible): number;

declare function TECCountAvailableSniffers(numberOfEncodings: interop.PointerConvertible): number;

declare function TECGetAvailableSniffers(availableSniffers: interop.Pointer, maxAvailableSniffers: number, actualAvailableSniffers: interop.PointerConvertible): number;

declare function TECCreateSniffer(encodingSniffer: interop.PointerConvertible, testEncodings: interop.Pointer, numTextEncodings: number): number;

declare function TECSniffTextEncoding(encodingSniffer: interop.PointerConvertible, inputBuffer: interop.PointerConvertible, inputBufferLength: number, testEncodings: interop.Pointer, numTextEncodings: number, numErrsArray: interop.Pointer, maxErrs: number, numFeaturesArray: interop.Pointer, maxFeatures: number): number;

declare function TECDisposeSniffer(encodingSniffer: interop.PointerConvertible): number;

declare function TECClearSnifferContextInfo(encodingSniffer: interop.PointerConvertible): number;

declare function TECSetBasicOptions(encodingConverter: interop.PointerConvertible, controlFlags: number): number;
...
declare function DisposeUnicodeToTextFallbackUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number): void;

declare function InvokeUnicodeToTextFallbackUPP(iSrcUniStr: interop.PointerConvertible, iSrcUniStrLen: number, oSrcConvLen: interop.PointerConvertible, oDestStr: interop.PointerConvertible, iDestStrLen: number, oDestConvLen: interop.PointerConvertible, iInfoPtr: interop.PointerConvertible, iUnicodeMappingPtr: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number): number;

declare function CreateTextToUnicodeInfo(iUnicodeMapping: interop.PointerConvertible, oTextToUnicodeInfo: interop.PointerConvertible): number;

declare function CreateTextToUnicodeInfoByEncoding(iEncoding: number, oTextToUnicodeInfo: interop.PointerConvertible): number;

declare function CreateUnicodeToTextInfo(iUnicodeMapping: interop.PointerConvertible, oUnicodeToTextInfo: interop.PointerConvertible): number;

declare function CreateUnicodeToTextInfoByEncoding(iEncoding: number, oUnicodeToTextInfo: interop.PointerConvertible): number;

declare function CreateUnicodeToTextRunInfo(iNumberOfMappings: number, iUnicodeMappings: interop.Pointer, oUnicodeToTextInfo: interop.PointerConvertible): number;

declare function CreateUnicodeToTextRunInfoByEncoding(iNumberOfEncodings: number, iEncodings: interop.Pointer, oUnicodeToTextInfo: interop.PointerConvertible): number;

declare function CreateUnicodeToTextRunInfoByScriptCode(iNumberOfScriptCodes: number, iScripts: interop.Pointer, oUnicodeToTextInfo: interop.PointerConvertible): number;

declare function ChangeTextToUnicodeInfo(ioTextToUnicodeInfo: interop.PointerConvertible, iUnicodeMapping: interop.PointerConvertible): number;

declare function ChangeUnicodeToTextInfo(ioUnicodeToTextInfo: interop.PointerConvertible, iUnicodeMapping: interop.PointerConvertible): number;

declare function DisposeTextToUnicodeInfo(ioTextToUnicodeInfo: interop.PointerConvertible): number;

declare function DisposeUnicodeToTextInfo(ioUnicodeToTextInfo: interop.PointerConvertible): number;

declare function DisposeUnicodeToTextRunInfo(ioUnicodeToTextRunInfo: interop.PointerConvertible): number;

declare function ConvertFromTextToUnicode(iTextToUnicodeInfo: interop.PointerConvertible, iSourceLen: number, iSourceStr: interop.PointerConvertible, iControlFlags: number, iOffsetCount: number, iOffsetArray: interop.Pointer, oOffsetCount: interop.PointerConvertible, oOffsetArray: interop.Pointer, iOutputBufLen: number, oSourceRead: interop.PointerConvertible, oUnicodeLen: interop.PointerConvertible, oUnicodeStr: interop.Pointer): number;

declare function ConvertFromUnicodeToText(iUnicodeToTextInfo: interop.PointerConvertible, iUnicodeLen: number, iUnicodeStr: interop.Pointer, iControlFlags: number, iOffsetCount: number, iOffsetArray: interop.Pointer, oOffsetCount: interop.PointerConvertible, oOffsetArray: interop.Pointer, iOutputBufLen: number, oInputRead: interop.PointerConvertible, oOutputLen: interop.PointerConvertible, oOutputStr: interop.PointerConvertible): number;

declare function ConvertFromUnicodeToTextRun(iUnicodeToTextInfo: interop.PointerConvertible, iUnicodeLen: number, iUnicodeStr: interop.Pointer, iControlFlags: number, iOffsetCount: number, iOffsetArray: interop.Pointer, oOffsetCount: interop.PointerConvertible, oOffsetArray: interop.Pointer, iOutputBufLen: number, oInputRead: interop.PointerConvertible, oOutputLen: interop.PointerConvertible, oOutputStr: interop.PointerConvertible, iEncodingRunBufLen: number, oEncodingRunOutLen: interop.PointerConvertible, oEncodingRuns: interop.Pointer): number;

declare function ConvertFromUnicodeToScriptCodeRun(iUnicodeToTextInfo: interop.PointerConvertible, iUnicodeLen: number, iUnicodeStr: interop.Pointer, iControlFlags: number, iOffsetCount: number, iOffsetArray: interop.Pointer, oOffsetCount: interop.PointerConvertible, oOffsetArray: interop.Pointer, iOutputBufLen: number, oInputRead: interop.PointerConvertible, oOutputLen: interop.PointerConvertible, oOutputStr: interop.PointerConvertible, iScriptRunBufLen: number, oScriptRunOutLen: interop.PointerConvertible, oScriptCodeRuns: interop.Pointer): number;

declare function TruncateForTextToUnicode(iTextToUnicodeInfo: interop.PointerConvertible, iSourceLen: number, iSourceStr: interop.PointerConvertible, iMaxLen: number, oTruncatedLen: interop.PointerConvertible): number;

declare function TruncateForUnicodeToText(iUnicodeToTextInfo: interop.PointerConvertible, iSourceLen: number, iSourceStr: interop.Pointer, iControlFlags: number, iMaxLen: number, oTruncatedLen: interop.PointerConvertible): number;

declare function ConvertFromPStringToUnicode(iTextToUnicodeInfo: interop.PointerConvertible, iPascalStr: interop.PointerConvertible, iOutputBufLen: number, oUnicodeLen: interop.PointerConvertible, oUnicodeStr: interop.Pointer): number;

declare function ConvertFromUnicodeToPString(iUnicodeToTextInfo: interop.PointerConvertible, iUnicodeLen: number, iUnicodeStr: interop.Pointer, oPascalStr: unknown /* const array */): number;

declare function CountUnicodeMappings(iFilter: number, iFindMapping: interop.PointerConvertible, oActualCount: interop.PointerConvertible): number;

declare function QueryUnicodeMappings(iFilter: number, iFindMapping: interop.PointerConvertible, iMaxCount: number, oActualCount: interop.PointerConvertible, oReturnedMappings: interop.Pointer): number;

declare function SetFallbackUnicodeToText(iUnicodeToTextInfo: interop.PointerConvertible, iFallback: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number, iControlFlags: number, iInfoPtr: interop.PointerConvertible): number;

declare function SetFallbackUnicodeToTextRun(iUnicodeToTextRunInfo: interop.PointerConvertible, iFallback: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number, iControlFlags: number, iInfoPtr: interop.PointerConvertible): number;

declare function ResetTextToUnicodeInfo(ioTextToUnicodeInfo: interop.PointerConvertible): number;

declare function ResetUnicodeToTextInfo(ioUnicodeToTextInfo: interop.PointerConvertible): number;

declare function ResetUnicodeToTextRunInfo(ioUnicodeToTextRunInfo: interop.PointerConvertible): number;

declare function NewThreadEntryUPP(userRoutine: (p1: interop.PointerConvertible) => interop.Pointer): (p1: interop.PointerConvertible) => interop.Pointer;

declare function NewThreadSchedulerUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function NewThreadSwitchUPP(userRoutine: (p1: number, p2: interop.PointerConvertible) => void): (p1: number, p2: interop.PointerConvertible) => void;

declare function NewThreadTerminationUPP(userRoutine: (p1: number, p2: interop.PointerConvertible) => void): (p1: number, p2: interop.PointerConvertible) => void;

declare function NewDebuggerNewThreadUPP(userRoutine: (p1: number) => void): (p1: number) => void;

declare function NewDebuggerDisposeThreadUPP(userRoutine: (p1: number) => void): (p1: number) => void;

declare function NewDebuggerThreadSchedulerUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function DisposeThreadEntryUPP(userUPP: (p1: interop.PointerConvertible) => interop.Pointer): void;

declare function DisposeThreadSchedulerUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function DisposeThreadSwitchUPP(userUPP: (p1: number, p2: interop.PointerConvertible) => void): void;

declare function DisposeThreadTerminationUPP(userUPP: (p1: number, p2: interop.PointerConvertible) => void): void;

declare function DisposeDebuggerNewThreadUPP(userUPP: (p1: number) => void): void;

declare function DisposeDebuggerDisposeThreadUPP(userUPP: (p1: number) => void): void;

declare function DisposeDebuggerThreadSchedulerUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function InvokeThreadEntryUPP(threadParam: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => interop.Pointer): interop.Pointer;

declare function InvokeThreadSchedulerUPP(schedulerInfo: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function InvokeThreadSwitchUPP(threadBeingSwitched: number, switchProcParam: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible) => void): void;

declare function InvokeThreadTerminationUPP(threadTerminated: number, terminationProcParam: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible) => void): void;

declare function InvokeDebuggerNewThreadUPP(threadCreated: number, userUPP: (p1: number) => void): void;

declare function InvokeDebuggerDisposeThreadUPP(threadDeleted: number, userUPP: (p1: number) => void): void;

declare function InvokeDebuggerThreadSchedulerUPP(schedulerInfo: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function NewThread(threadStyle: number, threadEntry: (p1: interop.PointerConvertible) => interop.Pointer, threadParam: interop.PointerConvertible, stackSize: number, options: number, threadResult: interop.PointerConvertible, threadMade: interop.PointerConvertible): number;

declare function SetThreadScheduler(threadScheduler: (p1: interop.PointerConvertible) => number): number;

declare function SetThreadSwitcher(thread: number, threadSwitcher: (p1: number, p2: interop.PointerConvertible) => void, switchProcParam: interop.PointerConvertible, inOrOut: number): number;

declare function SetThreadTerminator(thread: number, threadTerminator: (p1: number, p2: interop.PointerConvertible) => void, terminationProcParam: interop.PointerConvertible): number;

declare function SetDebuggerNotificationProcs(notifyNewThread: (p1: number) => void, notifyDisposeThread: (p1: number) => void, notifyThreadScheduler: (p1: interop.PointerConvertible) => number): number;

declare function CreateThreadPool(threadStyle: number, numToCreate: number, stackSize: number): number;

declare function GetDefaultThreadStackSize(threadStyle: number, stackSize: interop.PointerConvertible): number;

declare function ThreadCurrentStackSpace(thread: number, freeStack: interop.PointerConvertible): number;

declare function DisposeThread(threadToDump: number, threadResult: interop.PointerConvertible, recycleThread: number): number;

declare function YieldToThread(suggestedThread: number): number;

declare function YieldToAnyThread(): number;

declare function GetCurrentThread(currentThreadID: interop.PointerConvertible): number;

declare function GetThreadState(threadToGet: number, threadState: interop.PointerConvertible): number;

declare function SetThreadState(threadToSet: number, newState: number, suggestedThread: number): number;

declare function SetThreadStateEndCritical(threadToSet: number, newState: number, suggestedThread: number): number;

declare function ThreadBeginCritical(): number;

declare function ThreadEndCritical(): number;

declare function GetThreadCurrentTaskRef(threadTRef: interop.PointerConvertible): number;

declare function GetThreadStateGivenTaskRef(threadTRef: interop.PointerConvertible, threadToGet: number, threadState: interop.PointerConvertible): number;

declare function SetThreadReadyGivenTaskRef(threadTRef: interop.PointerConvertible, threadToSet: number): number;

declare function FindFolder(vRefNum: number, folderType: number, createFolder: number, foundVRefNum: interop.PointerConvertible, foundDirID: interop.PointerConvertible): number;

declare function ReleaseFolder(vRefNum: number, folderType: number): number;

declare function FSFindFolder(vRefNum: number, folderType: number, createFolder: number, foundRef: interop.PointerConvertible): number;

declare function AddFolderDescriptor(foldType: number, flags: number, foldClass: number, foldLocation: number, badgeSignature: number, badgeType: number, name: interop.PointerConvertible, replaceFlag: number): number;

declare function GetFolderTypes(requestedTypeCount: number, totalTypeCount: interop.PointerConvertible, theTypes: interop.PointerConvertible): number;

declare function RemoveFolderDescriptor(foldType: number): number;

declare function GetFolderNameUnicode(vRefNum: number, foldType: number, foundVRefNum: interop.PointerConvertible, name: interop.PointerConvertible): number;

declare function InvalidateFolderDescriptorCache(vRefNum: number, dirID: number): number;

declare function IdentifyFolder(vRefNum: number, dirID: number, foldType: interop.PointerConvertible): number;

declare function FSDetermineIfRefIsEnclosedByFolder(domainOrVRefNum: number, folderType: number, inRef: interop.PointerConvertible, outResult: interop.PointerConvertible): number;

declare function DetermineIfPathIsEnclosedByFolder(domainOrVRefNum: number, folderType: number, utf8Path: interop.PointerConvertible, pathIsRealPath: number, outResult: interop.PointerConvertible): number;

declare function NewFolderManagerNotificationUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function DisposeFolderManagerNotificationUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function InvokeFolderManagerNotificationUPP(message: number, arg: interop.PointerConvertible, userRefCon: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function Microseconds(microTickCount: interop.PointerConvertible): void;

declare function InsTime(tmTaskPtr: interop.PointerConvertible): void;

declare function InsXTime(tmTaskPtr: interop.PointerConvertible): void;

declare function PrimeTime(tmTaskPtr: interop.PointerConvertible, count: number): void;

declare function RmvTime(tmTaskPtr: interop.PointerConvertible): void;

declare function InstallTimeTask(tmTaskPtr: interop.PointerConvertible): number;

declare function InstallXTimeTask(tmTaskPtr: interop.PointerConvertible): number;

declare function PrimeTimeTask(tmTaskPtr: interop.PointerConvertible, count: number): number;

declare function RemoveTimeTask(tmTaskPtr: interop.PointerConvertible): number;

declare function NewTimerUPP(userRoutine: (p1: interop.PointerConvertible) => void): (p1: interop.PointerConvertible) => void;

declare function DisposeTimerUPP(userUPP: (p1: interop.PointerConvertible) => void): void;

declare function InvokeTimerUPP(tmTaskPtr: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => void): void;

declare function MPGetNextCpuID(owningCoherenceID: interop.PointerConvertible, cpuID: interop.PointerConvertible): number;

declare function MPGetNextTaskID(owningProcessID: interop.PointerConvertible, taskID: interop.PointerConvertible): number;

declare function LMGetBootDrive(): number;

declare function LMSetBootDrive(value: number): void;

declare function LMGetApFontID(): number;

declare function LMSetApFontID(value: number): void;

declare function LMGetSysMap(): number;

declare function LMSetSysMap(value: number): void;

declare function LMGetResLoad(): number;

declare function LMSetResLoad(value: number): void;

declare function LMGetResErr(): number;

declare function LMSetResErr(value: number): void;

declare function LMGetTmpResLoad(): number;

declare function LMSetTmpResLoad(value: number): void;

declare function LMGetIntlSpec(): string;

declare function LMSetIntlSpec(value: string): void;

declare function LMSetSysFontFam(value: number): void;

declare function LMGetSysFontSize(): number;

declare function LMSetSysFontSize(value: number): void;

declare function NewAVLCompareItemsUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: number) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: number) => number;

declare function NewAVLItemSizeUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number;

declare function NewAVLDisposeItemUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void;

declare function NewAVLWalkUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number, p6: number, p7: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number, p6: number, p7: interop.PointerConvertible) => number;

declare function DisposeAVLCompareItemsUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: number) => number): void;

declare function DisposeAVLItemSizeUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): void;

declare function DisposeAVLDisposeItemUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function DisposeAVLWalkUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number, p6: number, p7: interop.PointerConvertible) => number): void;

declare function InvokeAVLCompareItemsUPP(tree: interop.PointerConvertible, i1: interop.PointerConvertible, i2: interop.PointerConvertible, nd_typ: number, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: number) => number): number;

declare function InvokeAVLItemSizeUPP(tree: interop.PointerConvertible, itemPtr: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): number;

declare function InvokeAVLDisposeItemUPP(tree: interop.PointerConvertible, dataP: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function InvokeAVLWalkUPP(tree: interop.PointerConvertible, dataPtr: interop.PointerConvertible, visitStage: number, node: number, level: number, balance: number, refCon: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number, p6: number, p7: interop.PointerConvertible) => number): number;

declare function NewAECoerceDescUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewAECoercePtrUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number;

declare function DisposeAECoerceDescUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function DisposeAECoercePtrUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): void;

declare function InvokeAECoerceDescUPP(fromDesc: interop.PointerConvertible, toType: number, handlerRefcon: interop.PointerConvertible, toDesc: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function InvokeAECoercePtrUPP(typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number, toType: number, handlerRefcon: interop.PointerConvertible, result: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): number;

declare function AEInstallCoercionHandler(fromType: number, toType: number, handler: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number, handlerRefcon: interop.PointerConvertible, fromTypeIsDesc: number, isSysHandler: number): number;

declare function AERemoveCoercionHandler(fromType: number, toType: number, handler: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number, isSysHandler: number): number;

declare function AEGetCoercionHandler(fromType: number, toType: number, handler: interop.PointerConvertible, handlerRefcon: interop.PointerConvertible, fromTypeIsDesc: interop.PointerConvertible, isSysHandler: number): number;

declare function AECoercePtr(typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number, toType: number, result: interop.PointerConvertible): number;

declare function AECoerceDesc(theAEDesc: interop.PointerConvertible, toType: number, result: interop.PointerConvertible): number;

declare function AEInitializeDesc(desc: interop.PointerConvertible): void;

declare function AECreateDesc(typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number, result: interop.PointerConvertible): number;

declare function AEDisposeDesc(theAEDesc: interop.PointerConvertible): number;

declare function AEDuplicateDesc(theAEDesc: interop.PointerConvertible, result: interop.PointerConvertible): number;

declare function AECreateDescFromExternalPtr(descriptorType: number, dataPtr: interop.PointerConvertible, dataLength: number, disposeCallback: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void, disposeRefcon: interop.PointerConvertible, theDesc: interop.PointerConvertible): number;

declare function AECompareDesc(desc1: interop.PointerConvertible, desc2: interop.PointerConvertible, resultP: interop.PointerConvertible): number;

declare function AECreateList(factoringPtr: interop.PointerConvertible, factoredSize: number, isRecord: number, resultList: interop.PointerConvertible): number;

declare function AECountItems(theAEDescList: interop.PointerConvertible, theCount: interop.PointerConvertible): number;

declare function AEPutPtr(theAEDescList: interop.PointerConvertible, index: number, typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number): number;

declare function AEPutDesc(theAEDescList: interop.PointerConvertible, index: number, theAEDesc: interop.PointerConvertible): number;

declare function AEGetNthPtr(theAEDescList: interop.PointerConvertible, index: number, desiredType: number, theAEKeyword: interop.PointerConvertible, typeCode: interop.PointerConvertible, dataPtr: interop.PointerConvertible, maximumSize: number, actualSize: interop.PointerConvertible): number;

declare function AEGetNthDesc(theAEDescList: interop.PointerConvertible, index: number, desiredType: number, theAEKeyword: interop.PointerConvertible, result: interop.PointerConvertible): number;

declare function AESizeOfNthItem(theAEDescList: interop.PointerConvertible, index: number, typeCode: interop.PointerConvertible, dataSize: interop.PointerConvertible): number;

declare function AEGetArray(theAEDescList: interop.PointerConvertible, arrayType: number, arrayPtr: interop.PointerConvertible, maximumSize: number, itemType: interop.PointerConvertible, itemSize: interop.PointerConvertible, itemCount: interop.PointerConvertible): number;

declare function AEPutArray(theAEDescList: interop.PointerConvertible, arrayType: number, arrayPtr: interop.PointerConvertible, itemType: number, itemSize: number, itemCount: number): number;

declare function AEDeleteItem(theAEDescList: interop.PointerConvertible, index: number): number;

declare function AECheckIsRecord(theDesc: interop.PointerConvertible): number;

declare function AECreateAppleEvent(theAEEventClass: number, theAEEventID: number, target: interop.PointerConvertible, returnID: number, transactionID: number, result: interop.PointerConvertible): number;

declare function AEPutParamPtr(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number): number;

declare function AEPutParamDesc(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, theAEDesc: interop.PointerConvertible): number;

declare function AEGetParamPtr(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, desiredType: number, actualType: interop.PointerConvertible, dataPtr: interop.PointerConvertible, maximumSize: number, actualSize: interop.PointerConvertible): number;

declare function AEGetParamDesc(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, desiredType: number, result: interop.PointerConvertible): number;

declare function AESizeOfParam(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, typeCode: interop.PointerConvertible, dataSize: interop.PointerConvertible): number;

declare function AEDeleteParam(theAppleEvent: interop.PointerConvertible, theAEKeyword: number): number;

declare function AEGetAttributePtr(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, desiredType: number, typeCode: interop.PointerConvertible, dataPtr: interop.PointerConvertible, maximumSize: number, actualSize: interop.PointerConvertible): number;

declare function AEGetAttributeDesc(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, desiredType: number, result: interop.PointerConvertible): number;

declare function AESizeOfAttribute(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, typeCode: interop.PointerConvertible, dataSize: interop.PointerConvertible): number;

declare function AEPutAttributePtr(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number): number;

declare function AEPutAttributeDesc(theAppleEvent: interop.PointerConvertible, theAEKeyword: number, theAEDesc: interop.PointerConvertible): number;

declare function AESizeOfFlattenedDesc(theAEDesc: interop.PointerConvertible): number;

declare function AEFlattenDesc(theAEDesc: interop.PointerConvertible, buffer: string, bufferSize: number, actualSize: interop.PointerConvertible): number;

declare function AEUnflattenDesc(buffer: interop.PointerConvertible, result: interop.PointerConvertible): number;

declare function AEUnflattenDescFromBytes(buffer: interop.PointerConvertible, bufferLen: number, result: interop.PointerConvertible): number;

declare function AEGetDescData(theAEDesc: interop.PointerConvertible, dataPtr: interop.PointerConvertible, maximumSize: number): number;

declare function AEGetDescDataSize(theAEDesc: interop.PointerConvertible): number;

declare function AEReplaceDescData(typeCode: number, dataPtr: interop.PointerConvertible, dataSize: number, theAEDesc: interop.PointerConvertible): number;

declare function AEGetDescDataRange(dataDesc: interop.PointerConvertible, buffer: interop.PointerConvertible, offset: number, length: number): number;

declare function NewAEDisposeExternalUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void;

declare function NewAEEventHandlerUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function DisposeAEDisposeExternalUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void): void;

declare function DisposeAEEventHandlerUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function InvokeAEDisposeExternalUPP(dataPtr: interop.PointerConvertible, dataLength: number, refcon: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void): void;

declare function InvokeAEEventHandlerUPP(theAppleEvent: interop.PointerConvertible, reply: interop.PointerConvertible, handlerRefcon: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function AEInstallEventHandler(theAEEventClass: number, theAEEventID: number, handler: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, handlerRefcon: interop.PointerConvertible, isSysHandler: number): number;

declare function AERemoveEventHandler(theAEEventClass: number, theAEEventID: number, handler: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, isSysHandler: number): number;

declare function AEGetEventHandler(theAEEventClass: number, theAEEventID: number, handler: interop.PointerConvertible, handlerRefcon: interop.PointerConvertible, isSysHandler: number): number;

declare function AEInstallSpecialHandler(functionClass: number, handler: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, isSysHandler: number): number;

declare function AERemoveSpecialHandler(functionClass: number, handler: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, isSysHandler: number): number;

declare function AEGetSpecialHandler(functionClass: number, handler: interop.PointerConvertible, isSysHandler: number): number;
...
declare function CreateOffsetDescriptor(theOffset: number, theDescriptor: interop.PointerConvertible): number;

declare function CreateCompDescriptor(comparisonOperator: number, operand1: interop.PointerConvertible, operand2: interop.PointerConvertible, disposeInputs: number, theDescriptor: interop.PointerConvertible): number;

declare function CreateLogicalDescriptor(theLogicalTerms: interop.PointerConvertible, theLogicOperator: number, disposeInputs: number, theDescriptor: interop.PointerConvertible): number;

declare function CreateObjSpecifier(desiredClass: number, theContainer: interop.PointerConvertible, keyForm: number, keyData: interop.PointerConvertible, disposeInputs: number, objSpecifier: interop.PointerConvertible): number;

declare function CreateRangeDescriptor(rangeStart: interop.PointerConvertible, rangeStop: interop.PointerConvertible, disposeInputs: number, theDescriptor: interop.PointerConvertible): number;

declare function NewOSLAccessorUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number;

declare function NewOSLCompareUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewOSLCountUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewOSLDisposeTokenUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function NewOSLGetMarkTokenUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number;

declare function NewOSLGetErrDescUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function NewOSLMarkUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number;

declare function NewOSLAdjustMarksUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible) => number): (p1: number, p2: number, p3: interop.PointerConvertible) => number;

declare function DisposeOSLAccessorUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number): void;

declare function DisposeOSLCompareUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function DisposeOSLCountUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function DisposeOSLDisposeTokenUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function DisposeOSLGetMarkTokenUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): void;

declare function DisposeOSLGetErrDescUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function DisposeOSLMarkUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): void;

declare function DisposeOSLAdjustMarksUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible) => number): void;

declare function InvokeOSLAccessorUPP(desiredClass: number, container: interop.PointerConvertible, containerClass: number, form: number, selectionData: interop.PointerConvertible, value: interop.PointerConvertible, accessorRefcon: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number): number;

declare function InvokeOSLCompareUPP(oper: number, obj1: interop.PointerConvertible, obj2: interop.PointerConvertible, result: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function InvokeOSLCountUPP(desiredType: number, containerClass: number, container: interop.PointerConvertible, result: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function InvokeOSLDisposeTokenUPP(unneededToken: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function InvokeOSLGetMarkTokenUPP(dContainerToken: interop.PointerConvertible, containerClass: number, result: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): number;

declare function InvokeOSLGetErrDescUPP(appDescPtr: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function InvokeOSLMarkUPP(dToken: interop.PointerConvertible, markToken: interop.PointerConvertible, index: number, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): number;

declare function InvokeOSLAdjustMarksUPP(newStart: number, newStop: number, markToken: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible) => number): number;

declare function AEObjectInit(): number;

declare function AESetObjectCallbacks(myCompareProc: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number, myCountProc: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number, myDisposeTokenProc: (p1: interop.PointerConvertible) => number, myGetMarkTokenProc: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number, myMarkProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number, myAdjustMarksProc: (p1: number, p2: number, p3: interop.PointerConvertible) => number, myGetErrDescProcPtr: (p1: interop.PointerConvertible) => number): number;

declare function AEResolve(objectSpecifier: interop.PointerConvertible, callbackFlags: number, theToken: interop.PointerConvertible): number;

declare function AEInstallObjectAccessor(desiredClass: number, containerType: number, theAccessor: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number, accessorRefcon: interop.PointerConvertible, isSysHandler: number): number;

declare function AERemoveObjectAccessor(desiredClass: number, containerType: number, theAccessor: (p1: number, p2: interop.PointerConvertible, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number, isSysHandler: number): number;

declare function AEGetObjectAccessor(desiredClass: number, containerType: number, accessor: interop.PointerConvertible, accessorRefcon: interop.PointerConvertible, isSysHandler: number): number;

declare function AEDisposeToken(theToken: interop.PointerConvertible): number;

declare function AECallObjectAccessor(desiredClass: number, containerToken: interop.PointerConvertible, containerClass: number, keyForm: number, keyData: interop.PointerConvertible, token: interop.PointerConvertible): number;
...
declare function AEStreamOpen(): interop.Pointer;

declare function AEStreamClose(ref: interop.PointerConvertible, desc: interop.PointerConvertible): number;

declare function AEStreamOpenDesc(ref: interop.PointerConvertible, newType: number): number;

declare function AEStreamWriteData(ref: interop.PointerConvertible, data: interop.PointerConvertible, length: number): number;

declare function AEStreamCloseDesc(ref: interop.PointerConvertible): number;

declare function AEStreamWriteDesc(ref: interop.PointerConvertible, newType: number, data: interop.PointerConvertible, length: number): number;

declare function AEStreamWriteAEDesc(ref: interop.PointerConvertible, desc: interop.PointerConvertible): number;

declare function AEStreamOpenList(ref: interop.PointerConvertible): number;

declare function AEStreamCloseList(ref: interop.PointerConvertible): number;

declare function AEStreamOpenRecord(ref: interop.PointerConvertible, newType: number): number;

declare function AEStreamSetRecordType(ref: interop.PointerConvertible, newType: number): number;

declare function AEStreamCloseRecord(ref: interop.PointerConvertible): number;

declare function AEStreamWriteKeyDesc(ref: interop.PointerConvertible, key: number, newType: number, data: interop.PointerConvertible, length: number): number;

declare function AEStreamOpenKeyDesc(ref: interop.PointerConvertible, key: number, newType: number): number;

declare function AEStreamWriteKey(ref: interop.PointerConvertible, key: number): number;

declare function AEStreamCreateEvent(clazz: number, id: number, targetType: number, targetData: interop.PointerConvertible, targetLength: number, returnID: number, transactionID: number): interop.Pointer;

declare function AEStreamOpenEvent(event: interop.PointerConvertible): interop.Pointer;

declare function AEStreamOptionalParam(ref: interop.PointerConvertible, key: number): number;

declare function AEGetRegisteredMachPort(): number;

declare function AEDecodeMessage(header: interop.PointerConvertible, event: interop.PointerConvertible, reply: interop.PointerConvertible): number;

declare function AEProcessMessage(header: interop.PointerConvertible): number;
...
declare function DisposeSleepQUPP(userUPP: (p1: number, p2: interop.PointerConvertible) => number): void;

declare function InvokeSleepQUPP(message: number, qRecPtr: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible) => number): number;

declare function GetCPUSpeed(): number;

declare function SleepQInstall(qRecPtr: interop.PointerConvertible): void;

declare function SleepQRemove(qRecPtr: interop.PointerConvertible): void;

declare function MaximumProcessorSpeed(): number;

declare function MinimumProcessorSpeed(): number;

declare function CurrentProcessorSpeed(): number;

declare function BatteryCount(): number;

declare function UpdateSystemActivity(activity: number): number;

declare function KCGetKeychainManagerVersion(returnVers: interop.PointerConvertible): number;

declare function KCSetInteractionAllowed(state: number): number;

declare function KCIsInteractionAllowed(): number;

declare function KCMakeKCRefFromFSRef(keychainFSRef: interop.PointerConvertible, keychain: interop.PointerConvertible): number;
...
declare function KCGetIndKeychain(index: number, keychain: interop.PointerConvertible): number;

declare function NewKCCallbackUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function DisposeKCCallbackUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function InvokeKCCallbackUPP(keychainEvent: number, info: interop.PointerConvertible, userContext: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function KCFindAppleSharePassword(serverSignature: interop.PointerConvertible, serverAddress: interop.PointerConvertible, serverName: interop.PointerConvertible, volumeName: interop.PointerConvertible, accountName: interop.PointerConvertible, maxLength: number, passwordData: interop.PointerConvertible, actualLength: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function KCFindInternetPassword(serverName: interop.PointerConvertible, securityDomain: interop.PointerConvertible, accountName: interop.PointerConvertible, port: number, protocol: number, authType: number, maxLength: number, passwordData: interop.PointerConvertible, actualLength: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function KCFindInternetPasswordWithPath(serverName: interop.PointerConvertible, securityDomain: interop.PointerConvertible, accountName: interop.PointerConvertible, path: interop.PointerConvertible, port: number, protocol: number, authType: number, maxLength: number, passwordData: interop.PointerConvertible, actualLength: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function KCFindGenericPassword(serviceName: interop.PointerConvertible, accountName: interop.PointerConvertible, maxLength: number, passwordData: interop.PointerConvertible, actualLength: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function KCAddCallback(callbackProc: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, eventMask: number, userContext: interop.PointerConvertible): number;

declare function KCRemoveCallback(callbackProc: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;
...
declare function kcfindinternetpassword(serverName: string, securityDomain: string, accountName: string, port: number, protocol: number, authType: number, maxLength: number, passwordData: interop.PointerConvertible, actualLength: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function kcfindinternetpasswordwithpath(serverName: string, securityDomain: string, accountName: string, path: string, port: number, protocol: number, authType: number, maxLength: number, passwordData: interop.PointerConvertible, actualLength: interop.PointerConvertible, item: interop.PointerConvertible): number;
...
declare function AcquireIconRef(theIconRef: interop.PointerConvertible): number;

declare function ReleaseIconRef(theIconRef: interop.PointerConvertible): number;

declare function GetIconRef(vRefNum: number, creator: number, iconType: number, theIconRef: interop.PointerConvertible): number;

declare function GetIconRefFromFolder(vRefNum: number, parentFolderID: number, folderID: number, attributes: number, accessPrivileges: number, theIconRef: interop.PointerConvertible): number;
...
declare function GetIconRefFromComponent(inComponent: interop.PointerConvertible, outIconRef: interop.PointerConvertible): number;

declare function RegisterIconRefFromIconFamily(creator: number, iconType: number, iconFamily: interop.PointerConvertible, theIconRef: interop.PointerConvertible): number;

declare function RegisterIconRefFromFSRef(creator: number, iconType: number, iconFile: interop.PointerConvertible, theIconRef: interop.PointerConvertible): number;

declare function UnregisterIconRef(creator: number, iconType: number): number;

declare function UpdateIconRef(theIconRef: interop.PointerConvertible): number;

declare function OverrideIconRef(oldIconRef: interop.PointerConvertible, newIconRef: interop.PointerConvertible): number;

declare function RemoveIconRefOverride(theIconRef: interop.PointerConvertible): number;

declare function CompositeIconRef(backgroundIconRef: interop.PointerConvertible, foregroundIconRef: interop.PointerConvertible, compositeIconRef: interop.PointerConvertible): number;

declare function IsIconRefComposite(compositeIconRef: interop.PointerConvertible, backgroundIconRef: interop.PointerConvertible, foregroundIconRef: interop.PointerConvertible): number;

declare function IsValidIconRef(theIconRef: interop.PointerConvertible): number;

declare function IsDataAvailableInIconRef(inIconKind: number, inIconRef: interop.PointerConvertible): number;

declare function SetCustomIconsEnabled(vRefNum: number, enableCustomIcons: number): number;

declare function GetCustomIconsEnabled(vRefNum: number, customIconsEnabled: interop.PointerConvertible): number;
...
declare function LSGetExtensionInfo(inNameLen: number, inNameBuffer: interop.Pointer, outExtStartIndex: interop.PointerConvertible): number;
...
declare function LSOpenFSRef(inRef: interop.PointerConvertible, outLaunchedRef: interop.PointerConvertible): number;

declare function LSOpenFromRefSpec(inLaunchSpec: interop.PointerConvertible, outLaunchedRef: interop.PointerConvertible): number;

declare function LSOpenApplication(appParams: interop.PointerConvertible, outPSN: interop.PointerConvertible): number;
...
declare function FSEventsPurgeEventsForDeviceUpToEventId(dev: number, eventId: number): number;

declare function FSEventStreamRetain(streamRef: interop.PointerConvertible): void;
...
declare function FSEventStreamInvalidate(streamRef: interop.PointerConvertible): void;

declare function FSEventStreamStart(streamRef: interop.PointerConvertible): number;

declare function FSEventStreamFlushAsync(streamRef: interop.PointerConvertible): number;

declare function FSEventStreamFlushSync(streamRef: interop.PointerConvertible): void;

declare function FSEventStreamStop(streamRef: interop.PointerConvertible): void;
