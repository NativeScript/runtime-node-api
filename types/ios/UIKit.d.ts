...
declare interface UIApplicationDelegate extends NSObjectProtocol {
  ...
  applicationHandlerForIntent?(application: UIApplication, intent: interop.Object): interop.Object;

  applicationHandleIntentCompletionHandler?(application: UIApplication, intent: interop.Object, completionHandler: (p1: interop.Object) => void): void;
  ...
  applicationUserDidAcceptCloudKitShareWithMetadata?(application: UIApplication, cloudKitShareMetadata: interop.Object): void;
...
declare interface UIWindowSceneDelegate extends UISceneDelegate {
  ...
  windowSceneUserDidAcceptCloudKitShareWithMetadata?(windowScene: UIWindowScene, cloudKitShareMetadata: interop.Object): void;
}
...
declare class UIManagedDocument extends UIDocument {
  ...
  readonly managedObjectContext: interop.Object;

  readonly managedObjectModel: interop.Object;
...
declare class UICloudSharingController extends UIViewController {
  initWithPreparationHandler(preparationHandler: (p1: UICloudSharingController, p2: (p1: interop.Object, p2: interop.Object, p3: NSError) => void) => void | null): this;

  initWithShareContainer(share: interop.Object, container: interop.Object): this;

  delegate: UICloudSharingControllerDelegate | null;

  readonly share: interop.Object;
...
declare class UISceneConnectionOptions extends NSObject {
  ...
  readonly cloudKitShareMetadata: interop.Object;
}
